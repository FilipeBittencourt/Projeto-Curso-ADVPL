...
User Function VIXA257()
	...
	Private cTitulo := "Cadastro PC x Rota/Trecho"
...
Static Function MenuDef()
	...
	ADD OPTION aRot TITLE 'Visualizar' ACTION 'VIEWDEF.VIXA257' OPERATION MODEL_OPERATION_VIEW   ACCESS 0 //OPERATION 1
	//ADD OPTION aRot TITLE 'Incluir'    ACTION 'VIEWDEF.VIXA257' OPERATION MODEL_OPERATION_INSERT ACCESS 0 //OPERATION 3
	ADD OPTION aRot TITLE 'Alterar'    ACTION 'VIEWDEF.VIXA257' OPERATION MODEL_OPERATION_UPDATE ACCESS 0 //OPERATION 4
	//ADD OPTION aRot TITLE 'Excluir'    ACTION 'VIEWDEF.VIXA257' OPERATION MODEL_OPERATION_DELETE ACCESS 0 //OPERATION 5
...
Static Function ModelDef()
	...
	oFormPai:SetProperty('ZZE_CODFOR'	, MODEL_FIELD_INIT, {|oView| U_VIX257IG("SC7", 1, ZZE->ZZE_NUM		, "C7_FORNECE")})
	oFormPai:SetProperty('ZZE_LOJA'		, MODEL_FIELD_INIT, {|oView| U_VIX257IG("SC7", 1, ZZE->ZZE_NUM		, "C7_LOJA")})
...
Static Function ViewDef()
	...
	Local oModel     := FWLoadModel("VIXA257")
...
Static Function fTudoOK(oModel)
	...
	If !(RetCodUsr() $ cCodGestor)
		...
		If nOpc == MODEL_OPERATION_DELETE .Or. nOpc == MODEL_OPERATION_UPDATE 
			...
			If SC7->C7_CONAPRO <> "B" // Ja liberado
...
User Function VIX257PC()
	...
	If nOpc == MODEL_OPERATION_INSERT
		...
		If (ZZE->(DBSEEK(xFilial("ZZE")+oModel:GetValue('FORMPAI','ZZE_NUM')))) // posiciona no primeiro registro da tabela em questão segundo a ordem do indice no  dbSetOrder(1)
	...
	If !(SC7->(DBSEEK(xFilial("SC7")+oModel:GetValue('FORMPAI','ZZE_NUM')))) // posiciona no primeiro registro da tabela em questão segundo a ordem do indice no  dbSetOrder(1)
