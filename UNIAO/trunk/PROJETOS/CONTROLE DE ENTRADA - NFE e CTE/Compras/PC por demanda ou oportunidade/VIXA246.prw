...
ฑฑบPrograma  ณVIXA246   บAutor  ณIhorran Milholi     บ Data ณ  12/03/13   บฑฑ
...
User Function VIXA246(aParam,cFabric,cCurvaDe,cCurvaAte,nQdeDias)
	...
	If AllTrim(FunName())$ UPPER('SchedPCompras')
		...
		//==================================================
		//Paramentro informando a data final da execu็ใo do 
		//schedule de pedido de compras
		//==================================================
		CriaParam()
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัอออออออออออออหอออออออัอออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณVA246CRUSemPCบAutor  ณIhorran Milholi  บ Data ณ  12/03/13   บฑฑ
ฑฑฬออออออออออุอออออออออออออสอออออออฯอออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
ฑฑบPrograma  ณVA246ResSolบAutor  ณIhorran Milholi    บ Data ณ  12/03/13   บฑฑ
...
Static Function VA246ResSol(cFabric, cCurvaDe, cCurvaAte)
	...
	//Se jแ existir uma solicita็ใo continua gravando nele	
	If !(cAliasSol)->(Eof())
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัอออออออออออหอออออออัอออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณVA246GerPedบAutor  ณIhorran Milholi    บ Data ณ  12/03/13   บฑฑ
ฑฑฬออออออออออุอออออออออออสอออออออฯอออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
Static Function VA246GerPed(aErros, cFabric, cCurvaDe, cCurvaAte, nQdeDias)
			...
			If SA2->(dbSeek(xFilial("SA2")+cFornece))		
				...
				Do While .T.
					If oControlSched:ControlJOB("U_PedidoComprasV246_"+cEmpAnt, nTrheads)
						...
						//Transmissใo da NF para SEFAZ e envio de notas entre grupo
	...
	//Fiz isso porque o protheus estava dando ACCESS VIOLETION na fun็ใo GetUserInfoArray
	//Ao executar a fun็ใo FreeObj, o sistema limpa a mem๓ria dos dados do objeto
...
@since 23/11/2017
@version 1.0
@param aParms, array, (Descri็ใo do parโmetro)
@return ${return}, ${return_description}
@example
(examples)
@see (links_or_references)
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัอออออออออออหอออออออัอออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณVA246PedMinบAutor  ณIhorran Milholi    บ Data ณ  23/01/16   บฑฑ
ฑฑฬออออออออออุอออออออออออสอออออออฯอออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณRotina para gera็ใo de pedidos de compra                    บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
...
Static Function VA246PedMin(aErros, cFabric, cCurvaDe, cCurvaAte)
	...
	Local cEmailOut	:= SuperGetMv("MV_Y246EML",.F.,"filipe.vieira@facilesistemas.com.br")
	Local cDestin	:= ""
	Local oExcel
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัอออออออออออหอออออออัอออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณVA246JobPedบAutor  ณIhorran Milholi    บ Data ณ  12/03/13   บฑฑ
ฑฑฬออออออออออุอออออออออออสอออออออฯอออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณRotina para gera็ใo de pedidos de compra                    บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัอออออออออออหอออออออัอออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณVA246GerSolบAutor  ณIhorran Milholi    บ Data ณ  12/03/13   บฑฑ
ฑฑฬออออออออออุอออออออออออสอออออออฯอออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
Static Function VA246GerSol(cFabric, cCurvaDe, cCurvaAte, nQdeDias)
	...
	aAdd(aParam,Replicate(" ",TamSX3("B1_GRUPO")[1]))	//ณ mv_par03     // Grupo de                    ณ
	aAdd(aParam,Replicate("Z",TamSX3("B1_GRUPO")[1]))	//ณ mv_par04     // Grupo ate                   ณ
...
@since 22/11/2017
@version 1.0
@param aParams, array, (Descri็ใo do parโmetro)
@return ${return}, ${return_description}
@example
(examples)
@see (links_or_references)
...
ฑฑบPrograma  ณVA246IniAmb บAutor ณIhorran Milholi    บ Data ณ  12/03/13   บฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออออหออออออัอออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณVA246ResiAmbบAutor ณIhorran Milholi    บ Data ณ  12/03/13   บฑฑ
ฑฑฬออออออออออุออออออออออออสออออออฯอออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
Local cEmail	:= "filipe.vieira@facilesistemas.com.br"
Local cArquivo	:= ""     
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัอออออออออออหออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณVA246Log   บAutor ณIhorran Milholi     บ Data ณ  28/05/13   บฑฑ
ฑฑฬออออออออออุอออออออออออสออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
ฑฑบPrograma  ณVA246FimProcPedบAutor ณIhorran Milholi บ Data ณ  28/05/13   บฑฑ
...
Static Function CriaParam()
	...
	If !GetMV(cParam,.T.)
		...
		RecLock( "SX6",.T. )
			...
			SX6->X6_VAR     := cParam
			SX6->X6_TIPO    := "D"	
			SX6->X6_DESCRIC := 'Parametro para informando a data da finaliza็ใo do'
