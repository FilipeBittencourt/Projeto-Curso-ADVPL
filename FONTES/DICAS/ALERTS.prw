...
User Function ALERTS()
  ...
  FwAlertError('Função <b>FwAlertError("Corpo da msg.","Titulo")</b>','Error')
  FwAlertInfo('Função <b>FwAlertInfo("Corpo da msg.","Titulo")','Info')
  FwAlertSuccess('Função <b>FwAlertSuccess("Corpo da msg.","Titulo")','Success')
  FwAlertWarning('Função <b>FwAlertWarning("Corpo da msg.","Titulo")','Warning')
  FwAlertYesNo('Função <b>FwAlertYesNo("Corpo da msg.","Titulo")','YesNo')
  If MsgYesNo(" Função  -  <b>MsgYesNo()</b>","ATENÇÃO","YES NO")
    If .T.
      // prosseguir...
    endif
  EndIf
