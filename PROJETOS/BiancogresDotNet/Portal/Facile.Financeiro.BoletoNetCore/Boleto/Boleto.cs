...
namespace Facile.Financeiro.BoletoNetCore
{
    ...
    public class Boleto
    {
        ...
        public void ValidarDados()
        {
            ...
            // Adição de Multa e Outros valores
            if (ValorOutrosAcrescimos != 0 || ValorMulta != 0 || ValorDesconto != 0)
            {
                ValorPago = ValorTitulo;
                ValorPago += ValorOutrosAcrescimos;
            ...
            CodigoBarra.LinhaDigitavelTexto = CodigoBarra.LinhaDigitavel;
        }
    }
}