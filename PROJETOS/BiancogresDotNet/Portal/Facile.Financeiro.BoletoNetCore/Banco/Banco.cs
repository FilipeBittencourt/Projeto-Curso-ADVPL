...
namespace Facile.Financeiro.BoletoNetCore
{
    public static class Banco
    {
        ...
        public static void FormataCodigoBarra(Boleto boleto)
        {
            ...
            if (boleto.ValorPago != 0 && boleto.ValorPago != boleto.ValorTitulo)
                codigoBarra.ValorDocumento = boleto.ValorPago.ToString("N2").Replace(",", "").Replace(".", "").PadLeft(10, '0');
            else
