    ...
    internal sealed class BancoBradesco : IBanco
    {
        ...
        private string GerarDetalheRemessaCNAB400Registro1(Boleto boleto, ref int numeroRegistroGeral)
        {
            try
            {
                ...
                reg.Adicionar(TTiposDadoEDI.ediAlphaAliEsquerda_____, 0007, 001, 0, Empty, '0');
                ...
                reg.Adicionar(TTiposDadoEDI.ediAlphaAliEsquerda_____, 0020, 001, 0, Empty, '0');
                ...
                reg.Adicionar(TTiposDadoEDI.ediAlphaAliEsquerda_____, 0094, 001, 0, Empty, 'N');
                ...
                //Somando valor de Outros Acrescimos para envio ao banco - nao existe campo destacado na API para essa finalidade    
