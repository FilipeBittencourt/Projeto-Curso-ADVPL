...
namespace Facile.Financeiro.BoletoNetCore
{
    public interface IBanco
    {
        ...
        //INTERFACES PARA REGISTROS DE RETORNO DE PAGAMENTO
        void LerDetalheRetornoCNAB240SegmentoG(ref Pagamento pagamento, string registro);
        void LerDetalheRetornoCNAB240SegmentoA(ref Pagamento pagamento, string registro);
        void LerDetalheRetornoCNAB240SegmentoB(ref Pagamento pagamento, string registro);
        void LerDetalheRetornoCNAB240SegmentoJ(ref Pagamento pagamento, string registro);
        void LerDetalheRetornoCNAB240SegmentoZ(ref Pagamento pagamento, string registro);
        void LerDetalheRetornoCNAB240SegmentoE(ref Pagamento pagamento, string registro);
        void LerDetalheRetornoCNAB240SegmentoO(ref Pagamento pagamento, string registro);
