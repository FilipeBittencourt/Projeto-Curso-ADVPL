        ...
        public void GerarArquivoRemessa(Boletos boletos, Stream arquivo)
        {
            try
            {
                ...
                foreach (Boleto boleto in boletos)
                {
                    ...
                    //Fernando em 08/05/2019 -> Somar valor do acrescimo no titulo (GNRE e outros) - no arquivo de remessa não tem campo específico
                    boleto.ValorTitulo += boleto.ValorOutrosAcrescimos;
