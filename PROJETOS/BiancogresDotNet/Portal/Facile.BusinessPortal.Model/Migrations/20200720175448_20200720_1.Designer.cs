...
namespace Facile.BusinessPortal.Model.Migrations
{
    ...
    [Migration("20200720175448_20200720_1")]
    partial class _20200720_1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Facile.BusinessPortal.Model.Acesso.UsuarioEmpresa", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Facile.BusinessPortal.Model.ExcecaoAgenda", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<decimal>("HoraDisponivel");
            ...
            modelBuilder.Entity("Facile.BusinessPortal.Model.LocalEntrega", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Facile.BusinessPortal.Model.Motorista", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Facile.BusinessPortal.Model.NotaFiscalCompra", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<bool>("EntregaAutorizada");
                    ...
                    b.Property<string>("ItemProduto");

                    b.Property<DateTime?>("LastEditDate");

                    b.Property<string>("LastEditUser");

                    b.Property<long?>("LocalEntregaID");
                    ...
                    b.Property<long?>("PedidoCompraID");
            ...
            modelBuilder.Entity("Facile.BusinessPortal.Model.PedidoCompra", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Facile.BusinessPortal.Model.TempoDescarregamento", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("TempoDescarregamento");
                });
            ...
            modelBuilder.Entity("Facile.BusinessPortal.Model.TipoProduto", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Facile.BusinessPortal.Model.TipoVeiculo", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Facile.BusinessPortal.Model.Transportadora", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Facile.BusinessPortal.Model.UsuarioTransportadora", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("UsuarioTransportadora");
                });
            ...
            modelBuilder.Entity("Facile.BusinessPortal.Model.NotaFiscalCompra", b =>
                {
                    ...
                    b.HasOne("Facile.BusinessPortal.Model.LocalEntrega", "LocalEntrega")
                        .WithMany()
                        .HasForeignKey("LocalEntregaID")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Facile.BusinessPortal.Model.Motorista", "Motorista")
                        .WithMany()
                        .HasForeignKey("MotoristaID")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Facile.BusinessPortal.Model.PedidoCompra", "PedidoCompra")
                        .WithMany("NotaFiscais")
                        .HasForeignKey("PedidoCompraID")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Facile.BusinessPortal.Model.TipoProduto", "TipoProduto")
                        .WithMany()
                        .HasForeignKey("TipoProdutoID")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Facile.BusinessPortal.Model.TipoVeiculo", "TipoVeiculo")
                        .WithMany()
                        .HasForeignKey("TipoVeiculoID")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Facile.BusinessPortal.Model.Transportadora", "Transportadora")
                        .WithMany()
