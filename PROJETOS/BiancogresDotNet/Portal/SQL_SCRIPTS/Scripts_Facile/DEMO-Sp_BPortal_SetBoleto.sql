...
begin
	...
	if (select count(1) from P12AUT.dbo.SE1990 SE1 where SE1.R_E_C_N_O_ = @NumeroControleParticipante and SE1.D_E_L_E_T_='') > 0
	begin
	
		set @NumeroDocumento = (select top 1 RTRIM(E1_NUM)+RTRIM(E1_PARCELA) from P12AUT.dbo.SE1990 SE1 where SE1.R_E_C_N_O_ = @NumeroControleParticipante and SE1.D_E_L_E_T_='')
