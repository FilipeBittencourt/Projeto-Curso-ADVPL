...
namespace Facile.BusinessPortal.Controllers.Extensions
{
    public static class UrlHelperExtensions
    {
        ...
        public static string AprovaAntecipacaoEmailCallbackLink(this IUrlHelper urlHelper, string scheme="")
        {
            return urlHelper.Action(action: nameof(AccountController.AprovaAntecipacaoEmail), controller: "Public", values: new
            {
            }, protocol: scheme);
        }
    }
