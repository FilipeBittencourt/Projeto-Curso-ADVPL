...
$(document).ready(function () {
		...
		$('.btn-novo-solicitante').on('click',
			function () {
				adicionarSolicitante('tabela-novo-solicitante');
			}
		);

		$("#tabela-novo-solicitante").on("click", ".btn-delete-solicitante",
			function () {
	...
	loadSelect2('select[name=UsuarioID]');
	loadSelect2('');
