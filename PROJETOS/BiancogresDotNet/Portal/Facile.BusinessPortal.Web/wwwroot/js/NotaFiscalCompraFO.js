    ...
    table = $('#dt-registro').DataTable(
        {
            ...
            buttons: [
                {
                    text: '<i class="fal fa-upload mr-1"></i> Importar XML',
            ...
            "columns": [
...

                {
                    "render": function (data, type, full, meta) {
                        ...
                        html += '<a title="Informar Pedido" href="javascript:void(0)" registroid="' + full.id + '" class="btn btn-icon fs-xl waves-effect waves-themed btn-modal-informar-pedido" >'
                        html += '<i class="fal fa-box color-fusion-300"></i>'
                        html += '</a>'

                        if (full.tipoFrete == 'CIF') {
                        ...
                        html += '<a title="Autorizar Entrega" href="javascript:void(0)" registroid="' + full.id + '" tipofrete="' + full.tipoFrete+'" class="btn btn-icon fs-xl waves-effect waves-themed btn-autorizar-entrega" >'
                        html += '<i class="fal fa-handshake color-fusion-300"></i>'
                        html += '</a>'
