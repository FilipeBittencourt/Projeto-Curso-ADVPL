            ...
            "columns": [
                ...
                
                {
                    "render": function (data, type, full, meta) {
                        ...
                        html += '<a title="Local Entrega" href="javascript:void(0)" registroid="' + full.id + '" class="btn btn-icon fs-xl waves-effect waves-themed btn-modal-informar-local-entrega" >'
                        html += '<i class="fal fa-map-signs color-fusion-300"></i>'
                        html += '</a>'
