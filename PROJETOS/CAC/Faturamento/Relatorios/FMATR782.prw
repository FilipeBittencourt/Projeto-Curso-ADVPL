...
±±³Programa  ³ FMATR782  ³ FILIPE - FACILE         ³ Data ³ 15-03-2019 ³±±
...
oReport := TReport():New("FMATR782",STR0018,"MR780A", {|oReport| ReportPrint(oReport,cAliasSD1,cAliasSD2,cAliasSA1)},STR0019 + " " + STR0020)	// "Estatisticas de Vendas (Cliente x Produto)"###"Este programa ira emitir a relacao das compras efetuadas pelo Cliente,"###"totalizando por produto e escolhendo a moeda forte para os Valores."
...
Static Function ReportPrint(oReport,cAliasSD1,cAliasSD2,cAliasSA1)
	...
	WHERE SD1.D1_FILIAL = %xFilial:SD1% AND
		...
		%Exp:cWhere% AND		    
		SD1.%NotDel%
	ORDER BY SD1.D1_FILIAL,SD1.D1_FORNECE,SD1.D1_LOJA,SD1.D1_DOC,SD1.D1_COD
	EndSql
	oReport:Section(2):EndQuery(/*Array com os parametros do tipo Range*/)

	A780CriaTmp({"D1_FILIAL","D1_FORNECE","D1_LOJA","D1_DOC","D1_SERIE","D1_COD"}, aStru, cSD1, cALiasSD1 )
	...
	DbSelectArea("SD2")
		...
		WHERE SD2.D2_FILIAL = %xFilial:SD2% AND
			...
			%Exp:cWhere% AND
			SD2.%NotDel%
		ORDER BY SD2.D2_FILIAL,SD2.D2_CLIENTE,SD2.D2_LOJA,SD2.D2_DOC,SD2.D2_SERIE,SD2.D2_COD,SD2.D2_ITEM
		EndSql
		oReport:Section(3):EndQuery()
		
		A780CriaTmp({"D2_FILIAL","D2_CLIENTE","D2_LOJA","D2_DOC","D2_SERIE","D2_COD","D2_ITEM"}, aStru, cSD2, cAliasSD2)
			...
			While !oReport:Cancel() .And.!Eof() .and. ;
				...
				While !oReport:Cancel() .And. ! Eof() .And. ;
					...
					*/
					...
					nVlrTot   := 0		// na impressao dos outros vendedores
					IF ALLTRIM((cSD2)->D2_DOC) != ALLTRIM(cNFAux)	
					...
					/*
						...
						*/
					 	...
					 	nVlrTot := Posicione('SF2',1,FWXFilial('SD2')+(cSD2)->D2_DOC+(cSD2)->D2_SERIE+(cSD2)->D2_CLIENTE+(cSD2)->D2_LOJA,'F2_VALBRUT')//F2_FILIAL, F2_DOC, F2_SERIE, F2_CLIENTE, F2_LOJA, F2_FORMUL, F2_TIPO, R_E_C_N_O_, D_E_L_E_T_

					  // nVlrTot  := MaFisRet(,nVlrTot)
...
cQuery += " ORDER BY SD1.D1_FILIAL,SD1.D1_FORNECE,SD1.D1_LOJA,SD1.D1_DOC,SD1.D1_SERIE, SD1.D1_COD"
...
For nj := 1 to Len(aStru)
    ...
    EndIf	
Next nj
A780CriaTmp({"D1_FILIAL","D1_FORNECE","D1_LOJA","D1_DOC","D1_SERIE","D1_COD"}, aStru, cSD1, "SD1TRB")
...
cQuery += "ORDER BY SD2.D2_FILIAL,SD2.D2_CLIENTE,SD2.D2_LOJA,SD2.D2_DOC,SD2.D2_SERIE,SD2.D2_COD,SD2.D2_ITEM"
cQuery := ChangeQuery(cQuery)
...
A780CriaTmp({"D2_FILIAL","D2_CLIENTE","D2_LOJA","D2_DOC","D2_SERIE","D2_COD","D2_ITEM"}, aStru, cSD2, "SD2TRB")
