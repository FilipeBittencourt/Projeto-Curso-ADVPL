...
User Function PE01NFESEFAZ()
	...
	//|Altera descrição do produto para: Descricao + referencia |
	For nI := 1 To Len(aProd)
		
		If SB1->(dbSeek(xFilial("SB1")+aProd[nI,2]))
			
			//|Só altera descrição para produtos de venda |
	...
	// retorno deve ser exatamente nesta ordem e passando o conteúdo completo dos arrays
