...
/*/
//--------------------------------------------------------------------
User Function UPDOS001( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDOS001" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDOS001" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	{ 'Cli. Fat.'															, .T. }, ; //X3_TITSPA
	{ 'Cli. Fat.'															, .T. }, ; //X3_TITENG
	{ 'Cli. Fat.'															, .T. }, ; //X3_DESCRIC
	{ 'Cli. Fat.'															, .T. }, ; //X3_DESCSPA
	{ 'Cli. Fat.'															, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	...
	{ 'R'																	, .T. }, ; //X3_CONTEXT
	{ ''																	, .T. }, ; //X3_OBRIGAT
	{ 'ExistCpo("SA1",M->AB6_YCLI+RTRIM(M->AB6_YLJCLI),,,,!EMPTY(M->AB6_YLJCLI))'	, .T. }, ; //X3_VLDUSER
	{ ''																	, .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	{ 'AB6'																	, .T. }, ; //X3_ARQUIVO
	{ '07'																	, .T. }, ; //X3_ORDEM
	{ 'AB6_YLJCLI'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 2																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Lj. Cli. Fat'														, .T. }, ; //X3_TITULO
	{ 'Lj. Cli. Fat'														, .T. }, ; //X3_TITSPA
	{ 'Lj. Cli. Fat'														, .T. }, ; //X3_TITENG
	{ 'Loja Cliente Faturamento'											, .T. }, ; //X3_DESCRIC
	{ 'Loja Cliente Faturamento'											, .T. }, ; //X3_DESCSPA
	{ 'Loja Cliente Faturamento'											, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'AB6'																	, .T. }, ; //X3_ARQUIVO
	{ '08'																	, .T. }, ; //X3_ORDEM
	{ 'AB6_YNMCLI'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 30																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Nm. Cli. Fat'														, .T. }, ; //X3_TITULO
	{ 'Nm. Cli. Fat'														, .T. }, ; //X3_TITSPA
	{ 'Nm. Cli. Fat'														, .T. }, ; //X3_TITENG
	{ 'Nome Cliente Faturamento'											, .T. }, ; //X3_DESCRIC
	{ 'Nome Cliente Faturamento'											, .T. }, ; //X3_DESCSPA
	{ 'Nome Cliente Faturamento'											, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	{ 'IF(!INCLUI,POSICIONE("SA1", 1, XFILIAL("SA1") + AB6->(AB6_YCLI + AB6_YLJCLI), "A1_NOME"),"")', .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 0																		, .T. }, ; //X3_NIVEL
	{ Chr(254) + Chr(192)													, .T. }, ; //X3_RESERV
	{ ''																	, .T. }, ; //X3_CHECK
	...
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ ''																	, .T. }, ; //X3_WHEN
	{ 'Posicione("SA1", 1, xFilial("SA1") + AB6->(AB6_YCLI + AB6_LJCLI), "A1_NOME")', .T. }, ; //X3_INIBRW
	{ ''																	, .T. }, ; //X3_GRPSXG
	{ ''																	, .T. }, ; //X3_FOLDER
	{ ''																	, .T. }, ; //X3_CONDSQL
	{ ''																	, .T. }, ; //X3_CHKSQL
