...
User Function FINR004()
	...
	Private _cTitRel := "Relatório Compras por Centro de Custo e Natureza"
...
Static Function ReportDef()
	...
	TRCell():New(oSection3, "EMISSAO" , , "Emissão",,      15, .F.)
	...
	TRCell():New(oSection3, "DESPROD" , , "Descrição",,    40, .F.)
...
Static Function AjustaSX1(cPerg)
	...
	PutSx1(cPerg, "09", "Tipo Relator:         ", "", "", "mv_ch9", "N", 01, 00, 0, "C", ""          , ""    ,"", " ", "mv_par09", "1=Analitico    ", "", "", "", "2=Sintético    ", "", "", "               ", "", "", "               ", "", "", "               ", "", "", {},{},{},"")
