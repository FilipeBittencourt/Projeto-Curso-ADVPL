...
For Nx := 1 to Len(aProd)   
	...
	Else 
		cXml += '<ItemListaServico>'+ConvType2(aProd[Nx][24],5)+'</ItemListaServico>'   
	Endif
	If cCodMun $ "5201108-4104808-5103403-3524709-3300704-4313409-1400100-3156700-3205309-4308201" // Anápolis-GO, Cascavel-PR, Cuiabá-MT, Boa Vista-RR     
	...
	If (cCodMun $ "4318705" .And.  cTributa $ "58|63|64|59|68|69|78") .Or. (cCodMun $ "3106200" .And. aDest[22] == "EP" .And. cF4Agreg == "D") .or. cCodMun $ "-4303905-4307906"
