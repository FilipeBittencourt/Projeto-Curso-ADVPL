...
//	oSay1 := TSay():New(01,01,{||"Lorem"}, ,,,,,,.T.,,,20,10)
...
//
//	oWnd:= TWindow():New(0, 0, 500, 400, "CCL", NIL, NIL, NIL, NIL, NIL, NIL, NIL, CLR_BLACK, CLR_WHITE, NIL, NIL, NIL, NIL, NIL, NIL, .T. )
//
//	//-------------------
//	// Frame superior
//	//-------------------
...
//	oSayHeader := TSay():New(0,0,{||"<H1><font color=#424242>Central de Locações</H1>"},oHeaderLyt,,,,,,.T.,,,0,0,,,,,,.T.)
