...
/*/
//--------------------------------------------------------------------
User Function USB1PTOL( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "USB1PTOL" )
				Else
					MsgStop( "Atualização não Realizada.", "USB1PTOL" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	{ 3																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Prz.Toler.OP'														, .T. }, ; //X3_TITULO
	{ 'Prz.Toler.OP'														, .T. }, ; //X3_TITSPA
	{ 'Prz.Toler.OP'														, .T. }, ; //X3_TITENG
	{ 'Prz.Toler.OP'														, .T. }, ; //X3_DESCRIC
	{ 'Prz.Toler.OP'														, .T. }, ; //X3_DESCSPA
	{ 'Prz.Toler.OP'														, .T. }, ; //X3_DESCENG
	{ '@E 999'																, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
...
aAdd( aSX3, { ;
	{ 'SB1'																	, .T. }, ; //X3_ARQUIVO
	{ 'Z8'																	, .T. }, ; //X3_ORDEM
	{ 'B1_YINDCOM'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 6																		, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Ind.Compr.OP'														, .T. }, ; //X3_TITULO
	{ 'Ind.Compr.OP'														, .T. }, ; //X3_TITSPA
	{ 'Ind.Compr.OP'														, .T. }, ; //X3_TITENG
	{ 'Ind.Compr.OP'														, .T. }, ; //X3_DESCRIC
	{ 'Ind.Compr.OP'														, .T. }, ; //X3_DESCSPA
	{ 'Ind.Compr.OP'														, .T. }, ; //X3_DESCENG
