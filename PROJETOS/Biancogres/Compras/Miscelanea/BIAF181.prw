...
//--------------------------------------------------------------------
/*/{Protheus.doc} BIAF181
@author Tiago Rossini Coradini
@since 09/01/2020
@version 1.0
@description Função de update de dicionários para compatibilização cadastro de Tipos de Negociacoes de Taxa de Cambio
@obs Projeto: A-69 - Taxa de Câmbio
@type Function
/*/

//--------------------------------------------------------------------
User Function BIAF181( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "BIAF181" )
				Else
					MsgStop( "Atualização não Realizada.", "BIAF181" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX2, { ;
	...
	cPath																	, ; //X2_PATH
	'ZKV010'																, ; //X2_ARQUIVO
	'Tipo Negociação Taxa de Cambio'										, ; //X2_NOME
	'Tipo Negociação Taxa de Cambio'										, ; //X2_NOMESPA
	'Tipo Negociação Taxa de Cambio'										, ; //X2_NOMEENG
	'C'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX3, { ;
	...
	{ 'GETSXENUM("ZKV", "ZKV_CODIGO")'										, .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 0																		, .T. }, ; //X3_NIVEL
	{ Chr(254) + Chr(192)													, .T. }, ; //X3_RESERV
	{ ''																	, .T. }, ; //X3_CHECK
	...
	{ 'R'																	, .T. }, ; //X3_CONTEXT
	{ '€'																	, .T. }, ; //X3_OBRIGAT
	{ 'ExistChav("ZKV", M->ZKV_CODIGO)'										, .T. }, ; //X3_VLDUSER
	{ ''																	, .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	{ 'ZKV'																	, .T. }, ; //X3_ARQUIVO
	{ '04'																	, .T. }, ; //X3_ORDEM
	{ 'ZKV_TPCALC'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Tipo Calculo'														, .T. }, ; //X3_TITULO
	{ 'Tipo Calculo'														, .T. }, ; //X3_TITSPA
	{ 'Tipo Calculo'														, .T. }, ; //X3_TITENG
	{ 'Tipo de Calculo'														, .T. }, ; //X3_DESCRIC
	{ 'Tipo de Calculo'														, .T. }, ; //X3_DESCSPA
	{ 'Tipo de Calculo'														, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	{ 'R'																	, .T. }, ; //X3_CONTEXT
	{ '€'																	, .T. }, ; //X3_OBRIGAT
	{ 'Pertence("FM")'														, .T. }, ; //X3_VLDUSER
	{ 'F=Fixo;M=Medio'														, .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ ''																	, .T. }, ; //X3_WHEN
...
aAdd( aSX3, { ;
	{ 'ZKV'																	, .T. }, ; //X3_ARQUIVO
	{ '05'																	, .T. }, ; //X3_ORDEM
	{ 'ZKV_OPCALC'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Opição Calc.'														, .T. }, ; //X3_TITULO
	{ 'Opição Calc.'														, .T. }, ; //X3_TITSPA
	{ 'Opição Calc.'														, .T. }, ; //X3_TITENG
	{ 'Opição de Calculo'													, .T. }, ; //X3_DESCRIC
	{ 'Opição de Calculo'													, .T. }, ; //X3_DESCSPA
	{ 'Opição de Calculo'													, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	{ 'R'																	, .T. }, ; //X3_CONTEXT
	{ '€'																	, .T. }, ; //X3_OBRIGAT
	{ 'Pertence("DM")'														, .T. }, ; //X3_VLDUSER
	{ 'D=Dias;M=Meses'														, .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ ''																	, .T. }, ; //X3_WHEN
...
aAdd( aSX3, { ;
	...
	{ 'Quantidade Dia/Mes'													, .T. }, ; //X3_DESCRIC
	{ 'Quantidade Dia/Mes'													, .T. }, ; //X3_DESCSPA
	{ 'Quantidade Dia/Mes'													, .T. }, ; //X3_DESCENG
	{ '99'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'ZKV'																	, .T. }, ; //X3_ARQUIVO
	{ '07'																	, .T. }, ; //X3_ORDEM
	{ 'ZKV_QTDRET'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 2																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Qtd. Retroce'														, .T. }, ; //X3_TITULO
	{ 'Qtd. Retroce'														, .T. }, ; //X3_TITSPA
	{ 'Qtd. Retroce'														, .T. }, ; //X3_TITENG
	{ 'Quantidade a Retroceder'												, .T. }, ; //X3_DESCRIC
	{ 'Quantidade a Retroceder'												, .T. }, ; //X3_DESCSPA
	{ 'Quantidade a Retroceder'												, .T. }, ; //X3_DESCENG
	{ '99'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'AIA'																	, .T. }, ; //X3_ARQUIVO
	{ '13'																	, .T. }, ; //X3_ORDEM
	{ 'AIA_YTPNEG'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 3																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Tp Negociaca'														, .T. }, ; //X3_TITULO
	{ 'Tp Negociaca'														, .T. }, ; //X3_TITSPA
	{ 'Tp Negociaca'														, .T. }, ; //X3_TITENG
	{ 'Tipo de Negociação'													, .T. }, ; //X3_DESCRIC
	{ 'Tipo de Negociação'													, .T. }, ; //X3_DESCSPA
	{ 'Tipo de Negociação'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	{ 'R'																	, .T. }, ; //X3_CONTEXT
	{ ''																	, .T. }, ; //X3_OBRIGAT
	{ 'Vazio() .Or. Existcpo("ZKV")'										, .T. }, ; //X3_VLDUSER
	{ ''																	, .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	{ 'SF1'																	, .T. }, ; //X3_ARQUIVO
	{ 'DK'																	, .T. }, ; //X3_ORDEM
	{ 'F1_YTXNEG'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 11																	, .T. }, ; //X3_TAMANHO
	{ 4																		, .T. }, ; //X3_DECIMAL
	{ 'Taxa Negocia'														, .T. }, ; //X3_TITULO
	{ 'Taxa Negocia'														, .T. }, ; //X3_TITSPA
	{ 'Taxa Negocia'														, .T. }, ; //X3_TITENG
	{ 'Taxa Negociada'														, .T. }, ; //X3_DESCRIC
	{ 'Taxa Negociada'														, .T. }, ; //X3_DESCSPA
	{ 'Taxa Negociada'														, .T. }, ; //X3_DESCENG
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'DB'																	, ; //XB_COLUNA
	'Tipo Negociação Taxa'													, ; //XB_DESCRI
	'Tipo Negociação Taxa'													, ; //XB_DESCSPA
	'Tipo Negociação Taxa'													, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'ZKV'																	} ) //XB_CONTEM
...
//
aHlpPor := {}
aAdd( aHlpPor, 'Fixo: Utilizadado para cálculo de dias' )
aAdd( aHlpPor, 'ou meses corridos' )
aAdd( aHlpPor, 'Medio: Utilizado para cálculo da media' )
aAdd( aHlpPor, 'de dias ou meses' )

aHlpEng := {}

aHlpSpa := {}

PutSX1Help( "PZKV_TPCALC", aHlpPor, aHlpEng, aHlpSpa, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "ZKV_TPCALC" )

aHlpPor := {}
aAdd( aHlpPor, 'Opição de calculo em dias ou meses' )

aHlpEng := {}

aHlpSpa := {}

PutSX1Help( "PZKV_OPCALC", aHlpPor, aHlpEng, aHlpSpa, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "ZKV_OPCALC" )

aHlpPor := {}
aAdd( aHlpPor, 'Quantidade de dias ou meses utilizada' )
aAdd( aHlpPor, 'nocálculo' )

aHlpEng := {}

aHlpSpa := {}

PutSX1Help( "PZKV_QTD   ", aHlpPor, aHlpEng, aHlpSpa, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "ZKV_QTD" )

aHlpPor := {}
aAdd( aHlpPor, 'Quantidade de dias ou meses a' )
aAdd( aHlpPor, 'Retrocederantes do calculo' )

aHlpEng := {}

aHlpSpa := {}

PutSX1Help( "PZKV_QTDRET", aHlpPor, aHlpEng, aHlpSpa, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "ZKV_QTDRET" )

//
// Helps Tabela AIA
//
aHlpPor := {}
aAdd( aHlpPor, 'Tipo de negociação de taxa de cambio' )

aHlpEng := {}

aHlpSpa := {}

PutSX1Help( "PAIA_YTPNEG", aHlpPor, aHlpEng, aHlpSpa, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "AIA_YTPNEG" )
...
PutSX1Help( "PA2_YTPNEG ", aHlpPor, aHlpEng, aHlpSpa, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "A2_YTPNEG" )
...
PutSX1Help( "PC7_YTPNEG ", aHlpPor, aHlpEng, aHlpSpa, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "C7_YTPNEG" )
...
PutSX1Help( "PC8_YTPNEG ", aHlpPor, aHlpEng, aHlpSpa, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "C8_YTPNEG" )
...
PutSX1Help( "PF1_YTPNEG ", aHlpPor, aHlpEng, aHlpSpa, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "F1_YTPNEG" )

aHlpPor := {}
aAdd( aHlpPor, 'Taxa Negociada' )

aHlpEng := {}

aHlpSpa := {}

PutSX1Help( "PF1_YTXNEG ", aHlpPor, aHlpEng, aHlpSpa, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "F1_YTXNEG" )
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "BIAF181" ) ) ) ;
