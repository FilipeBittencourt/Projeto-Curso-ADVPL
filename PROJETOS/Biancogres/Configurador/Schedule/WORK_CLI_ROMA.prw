...
ฑฑบPROGRAMA  ณ WORK_CLI_ROMA  บAUTOR  ณBRUNO MADALENO      บ DATA ณ  28/10/08   บฑฑ
ฑฑฬออออออออออุออออออออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDESC.     ณ WORKFLOW RESPONSAVEL EM ENVIAR TODOS OS ROMANEIOS NO DIA PARA    บฑฑ
ฑฑบ          ณ OS CLIENTES                                                      บฑฑ
...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
USER FUNCTION WORK_CLI_ROMA(AA_EMPRESA)
...
//SELECIONA OS CLIENTES DOS ROMANEIOS EM ABERTO
//If AA_EMPRESA == "01"
	CSQL := ""
...
//	If AA_EMPRESA == "01"
//		cSql := ""
//		cSql += "SELECT	A1_COD, A1_NOME, A1_CGC, A1_TEL, A1_BAIRRO, A1_MUN, A1_EST, C5_TIPO AS TIPO, Z9_PEDIDO, Z9_PRODUTO, Z9_DESCRIC, SUM(Z9_QTDLIB) AS Z9_QTDLIB, SUM(Z9_PESOBR) AS Z9_PESOBR, AVG(DIAS) AS DIAS  " + Enter
//		cSql += "FROM " + Enter
//		cSql += "(SELECT A4_COD, A4_NOME, A4_TEL, A3_COD, A3_NOME, A3_NREDUZ, A3_TEL, C5_TIPO, A1_COD, C5_YCLIORI, C5_YLOJORI,	" + Enter
...
//		cSql += "GROUP BY A1_COD, A1_NOME, A1_CGC, A1_TEL, A1_BAIRRO, A1_MUN, A1_EST, C5_TIPO, Z9_PEDIDO, Z9_PRODUTO, Z9_DESCRIC " + Enter
		...
		cSql += "	WHERE SC9.C9_NFISCAL	= '' AND  " + Enter
		cSql += "					SC9.C9_BLEST		= '' AND  " + Enter
		cSql += "					SC9.C9_BLCRED		= '') TTT  " + Enter
		cSql += "GROUP BY A1_COD, A1_NOME, A1_CGC, A1_TEL, A1_BAIRRO, A1_MUN, A1_EST, C5_TIPO, Z9_PEDIDO, Z9_PRODUTO, Z9_DESCRIC "

/*	Else
		CSQL := ""
		CSQL	:= "SELECT	A1_COD, A1_NOME, A1_CGC, A1_TEL, A1_BAIRRO, A1_MUN, A1_EST, C5_TIPO AS TIPO, Z9_PEDIDO, Z9_PRODUTO, Z9_DESCRIC, SUM(Z9_PESOBR) AS Z9_PESOBR, AVG(DIAS) AS DIAS  " + Enter
		CSQL	+= "FROM  																						" + Enter
		...
		CSQL	+= "		Z9_EMISSAO, C5_EMISSAO, Z9_PESOBR, C5_VEND1, C5_VEND2, C5_TIPO, Z9_PEDIDO, Z9_AGREG, Z9_NUMERO, Z9_PRODUTO, Z9_DESCRIC, B1_UM, Z9_QTDLIB, Z9_QTDLIB2  " + Enter
	...
	IF ! _TRAB_AUX->(EOF())
		IF ALLTRIM(CEMAIL) <> ""
			...
			C_HTML += '  <tr> '
			C_HTML += '    <th width="751" rowspan="3" scope="col"> PEDIDOS DISPONIBILIZADOS PARA RETIRADA NO DIA </th> '
...
IF CEMPANT == "01"
	cRecebe		:= "ranisses.corona@biancogres.com.br" //CEMAIL
...
IF !lOK //.OR. lErro
	//MSGBOX("ERRO AO ENVIAR EMAIL PARA O REPRESENTANTE" + CCODIGO + " " + CNOME )
...
U_BIAEnvMail(,cRecebe,cAssunto,CCMENSAGEM)
