...
Static Function WORK_CLI()
	...
	cSql += "      TMP.C6_YDTNECE AS C6_YDTNECE, TMP.C6_LA,	TMP.C6_LOJA, TMP.C6_NOTA, TMP.C6_SERIE,	TMP.C6_DATFAT, TMP.C6_NUM, TMP.C6_COMIS1, TMP.C6_COMIS2, TMP.C6_COMIS3,	TMP.C6_COMIS4, TMP.C6_COMIS5, TMP.C6_YPALLET, TMP.C6_PEDCLI, " + Enter
...
Static Function COMIS_EMAIL()
	...
	ElseIf cEmpAnt == "14"
		cRecebe   	:= CEMAIL
		cRecebeCC	:= "" 
		cAssunto	:= "VINILICO - RELA«√O PESO DISPONIVEL POR CLIENTE "		
	EndIf
