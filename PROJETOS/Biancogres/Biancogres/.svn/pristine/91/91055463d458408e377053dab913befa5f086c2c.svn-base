...
Static Function RunExcel(aEmp, cVersao, cRevisa, cAnoRef)
	...
	For nW := 1 To Len(aEmp)
		...
		cTitSheet := "Extrato ZBZ x DRE - Empresa: " + aEmp[nW][1]
		...
		oFWExcel:AddColumn(cSheet, cTitSheet, "DTREF"	, 1)
		...
		// cSQL += "               AND ZBZ_DATA BETWEEN '20190701' AND '20190731' "
		...
		cSQL += "               CTS_YINCVG,  "
		cSQL += "               CTS_YNOCVG "
		cSQL += "         FROM " + RetFullName("CTS", aEmp[nW][1]) + " "
		...
		cSQL += "         INNER JOIN " + RetFullName("CT1", aEmp[nW][1]) + " B ON  "
		cSQL += "         ( "
		cSQL += "             B.CT1_FILIAL BETWEEN '  ' AND 'ZZ' "
		cSQL += "             AND B.CT1_CONTA = A.CONTA "
		cSQL += "             AND B.D_E_L_E_T_ = ' ' "
		cSQL += "         ) "
		cSQL += "         INNER JOIN " + RetFullName("CTH", aEmp[nW][1]) + " C ON  "
		cSQL += "         ( "
