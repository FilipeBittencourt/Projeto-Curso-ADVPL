...
/*/
//--------------------------------------------------------------------
User Function UPDTAF05( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDTAF05" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDTAF05" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX2, { ;
	'ZK8'																	, ; //X2_CHAVE
	cPath																	, ; //X2_PATH
	'ZK8'+cEmpr																, ; //X2_ARQUIVO
	'DEPOSITO IDENTIFICADO'													, ; //X2_NOME
	'DEPOSITO IDENTIFICADO'													, ; //X2_NOMESPA
	'DEPOSITO IDENTIFICADO'													, ; //X2_NOMEENG
	'E'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX3, { ;
	...
	{ 'GETSXENUM("ZK8", "ZK8_NUMERO")'										, .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 0																		, .T. }, ; //X3_NIVEL
	{ Chr(254) + Chr(192)													, .T. }, ; //X3_RESERV
	{ ''																	, .T. }, ; //X3_CHECK
...
aAdd( aSX3, { ;
	...
	{ 'Grp Clientes'														, .T. }, ; //X3_DESCRIC
	{ 'Grp Clientes'														, .T. }, ; //X3_DESCSPA
	{ 'Grp Clientes'														, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'ZK8'																	, .T. }, ; //X3_ARQUIVO
	{ '05'																	, .T. }, ; //X3_ORDEM
	{ 'ZK8_VENCDE'															, .T. }, ; //X3_CAMPO
	{ 'D'																	, .T. }, ; //X3_TIPO
	{ 8																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Vencto De'															, .T. }, ; //X3_TITULO
	{ 'Vencto De'															, .T. }, ; //X3_TITSPA
	{ 'Vencto De'															, .T. }, ; //X3_TITENG
	{ 'Vencto De'															, .T. }, ; //X3_DESCRIC
	{ 'Vencto De'															, .T. }, ; //X3_DESCSPA
	{ 'Vencto De'															, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'ZK8'																	, .T. }, ; //X3_ARQUIVO
	{ '06'																	, .T. }, ; //X3_ORDEM
	{ 'ZK8_VENCAT'															, .T. }, ; //X3_CAMPO
	{ 'D'																	, .T. }, ; //X3_TIPO
	{ 8																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Vencto Ate'															, .T. }, ; //X3_TITULO
	{ 'Vencto Ate'															, .T. }, ; //X3_TITSPA
	{ 'Vencto Ate'															, .T. }, ; //X3_TITENG
	{ 'Vencto Ate'															, .T. }, ; //X3_DESCRIC
	{ 'Vencto Ate'															, .T. }, ; //X3_DESCSPA
	{ 'Vencto Ate'															, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'ZK8'																	, .T. }, ; //X3_ARQUIVO
	{ '07'																	, .T. }, ; //X3_ORDEM
	{ 'ZK8_DATDPI'															, .T. }, ; //X3_CAMPO
	{ 'D'																	, .T. }, ; //X3_TIPO
	{ 8																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Dt Deposito'															, .T. }, ; //X3_TITULO
	{ 'Dt Deposito'															, .T. }, ; //X3_TITSPA
	{ 'Dt Deposito'															, .T. }, ; //X3_TITENG
	{ 'Data do Deposito'													, .T. }, ; //X3_DESCRIC
	{ 'Data do Deposito'													, .T. }, ; //X3_DESCSPA
	{ 'Data do Deposito'													, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 'Agencia'																, .T. }, ; //X3_TITSPA
	{ 'Agencia'																, .T. }, ; //X3_TITENG
	{ 'Agencia'																, .T. }, ; //X3_DESCRIC
	{ 'Agencia'																, .T. }, ; //X3_DESCSPA
	{ 'Agencia'																, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 'Conta Corrente'														, .T. }, ; //X3_DESCSPA
	{ 'Conta Corrente'														, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'ZK8'																	, .T. }, ; //X3_ARQUIVO
	{ '11'																	, .T. }, ; //X3_ORDEM
	{ 'ZK8_CALCJR'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Calc. Juros'															, .T. }, ; //X3_TITULO
	{ 'Calc. Juros'															, .T. }, ; //X3_TITSPA
	{ 'Calc. Juros'															, .T. }, ; //X3_TITENG
	{ 'Calcula Juros'														, .T. }, ; //X3_DESCRIC
	{ 'Calcula Juros'														, .T. }, ; //X3_DESCSPA
	{ 'Calcula Juros'														, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'ZK8'																	, .T. }, ; //X3_ARQUIVO
	{ '12'																	, .T. }, ; //X3_ORDEM
	{ 'ZK8_PERCJR'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 5																		, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ '% Juros Dia'															, .T. }, ; //X3_TITULO
	{ '% Juros Dia'															, .T. }, ; //X3_TITSPA
	{ '% Juros Dia'															, .T. }, ; //X3_TITENG
	{ 'Percentul Juros Diario'												, .T. }, ; //X3_DESCRIC
	{ 'Percentul Juros Diario'												, .T. }, ; //X3_DESCSPA
	{ 'Percentul Juros Diario'												, .T. }, ; //X3_DESCENG
...
aAdd( aSX3, { ;
	{ 'SE1'																	, .T. }, ; //X3_ARQUIVO
	{ 'X7'																	, .T. }, ; //X3_ORDEM
	{ 'E1_YNUMDPI'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 6																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Num Dep Ide'															, .T. }, ; //X3_TITULO
	{ 'Num Dep Ide'															, .T. }, ; //X3_TITSPA
	{ 'Num Dep Ide'															, .T. }, ; //X3_TITENG
	{ 'Num Deposito Identificado'											, .T. }, ; //X3_DESCRIC
	{ 'Num Deposito Identificado'											, .T. }, ; //X3_DESCSPA
	{ 'Num Deposito Identificado'											, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSIX, { ;
	'ZK8'																	, ; //INDICE
	'2'																		, ; //ORDEM
	'ZK8_FILIAL+ZK8_GRPVEN+ZK8_VENCDE+ZK8_VENCAT'							, ; //CHAVE
	'Grp Clientes+Vencto De+Vencto Ate'										, ; //DESCRICAO
	'Grp Clientes+Vencto De+Vencto Ate'										, ; //DESCSPA
	'Grp Clientes+Vencto De+Vencto Ate'										, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPDTAF05" ) ) ) ;
