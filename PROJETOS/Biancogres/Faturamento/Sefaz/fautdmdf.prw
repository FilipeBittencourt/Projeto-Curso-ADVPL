...
User Function fautdmdf(cIdEnt,oDamdfe,oSetup,cFilePrint,cNumero,cSerie)
...
DamdfeProc(@oDamdfe,.F.,cIdEnt,@lExistMDfe, cNumero,cSerie)

/*
RptStatus({|lEnd| DamdfeProc(@oDamdfe,@lEnd,cIdEnt,@lExistMDfe, cNumero,cSerie)},"Imprimindo Danfe...")
...
Static Function DamdfeProc(oDamdfe,lEnd,cIdEnt,lExistMDfe,cNumero,cSerie) 
