...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDZL5" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDZL5" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX2, { ;
	...
	cPath																	, ; //X2_PATH
	'ZL5010'																	, ; //X2_ARQUIVO
	'Cabecalho Pedido Fat. Parcial'											, ; //X2_NOME
	'Cabecalho Pedido Fat. Parcial'											, ; //X2_NOMESPA
	'Cabecalho Pedido Fat. Parcial'											, ; //X2_NOMEENG
	'C'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX2, { ;
	...
	cPath																	, ; //X2_PATH
	'ZL6010'																, ; //X2_ARQUIVO
	'Item Pedido Fat. Parcial'												, ; //X2_NOME
	'Item Pedido Fat. Parcial'												, ; //X2_NOMESPA
	'Item Pedido Fat. Parcial'												, ; //X2_NOMEENG
	'C'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX3, { ;
	{ 'ZL5'																	, .T. }, ; //X3_ARQUIVO
	{ '05'																	, .T. }, ; //X3_ORDEM
	{ 'ZL5_QTDNF'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 5																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Qtd. Notas'															, .T. }, ; //X3_TITULO
	{ 'Qtd. Notas'															, .T. }, ; //X3_TITSPA
	{ 'Qtd. Notas'															, .T. }, ; //X3_TITENG
	{ 'Qtd. Notas'															, .T. }, ; //X3_DESCRIC
	{ 'Qtd. Notas'															, .T. }, ; //X3_DESCSPA
	{ 'Qtd. Notas'															, .T. }, ; //X3_DESCENG
	...
	{ 'R'																	, .T. }, ; //X3_CONTEXT
	{ ''																	, .T. }, ; //X3_OBRIGAT
	{ 'Positivo() .And. U_BAC020R()'										, .T. }, ; //X3_VLDUSER
	{ ''																	, .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	...
	{ 'Codigo del Transportador'											, .T. }, ; //X3_DESCSPA
	{ 'Carrier Code'														, .T. }, ; //X3_DESCENG
	{ '@X'																	, .T. }, ; //X3_PICTURE
	{ 'vazio() .or. existcpo("SA4")'										, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	...
	{ 'Clase 1'																, .T. }, ; //X3_TITSPA
	{ 'Class 1'																, .T. }, ; //X3_TITENG
	{ 'Especie do Volume tipo 1'											, .T. }, ; //X3_DESCRIC
	{ 'Clase de volumen tipo 1'												, .T. }, ; //X3_DESCSPA
	{ 'Class of volume type 1'												, .T. }, ; //X3_DESCENG
	{ '@X'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 'Volumes'																, .T. }, ; //X3_TITSPA
	{ 'Volumes'																, .T. }, ; //X3_TITENG
	{ 'Volumes'																, .T. }, ; //X3_DESCRIC
	{ 'Volumes'																, .T. }, ; //X3_DESCSPA
	{ 'Volumes'																, .T. }, ; //X3_DESCENG
...
aAdd( aSX3, { ;
	{ 'ZL5'																	, .T. }, ; //X3_ARQUIVO
	{ '10'																	, .T. }, ; //X3_ORDEM
	{ 'ZL5_QTDVEN'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 9																		, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Quant./Nf'															, .T. }, ; //X3_TITULO
...
aAdd( aSX3, { ;
	...
	{ 2																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'UF Placa'															, .T. }, ; //X3_TITULO
	{ 'UF Placa'															, .T. }, ; //X3_TITSPA
	{ 'UF Placa'															, .T. }, ; //X3_TITENG
	{ 'UF Placa'															, .T. }, ; //X3_DESCRIC
	{ 'UF Placa'															, .T. }, ; //X3_DESCSPA
	{ 'UF Placa'															, .T. }, ; //X3_DESCENG
	{ '@R AA'																, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	{ 'R'																	, .T. }, ; //X3_CONTEXT
	{ ''																	, .T. }, ; //X3_OBRIGAT
	{ 'ExistCpo("SX5", "12" + M->ZL6_UF, 1)'								, .T. }, ; //X3_VLDUSER
	{ ''																	, .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	{ 'ZL6'																	, .T. }, ; //X3_ARQUIVO
	{ '10'																	, .T. }, ; //X3_ORDEM
	{ 'ZL6_PLIQUI'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 9																		, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Peso Liquido'																, .T. }, ; //X3_TITULO
	{ 'Peso Liquido'																, .T. }, ; //X3_TITSPA
	{ 'Peso Liquido'																, .T. }, ; //X3_TITENG
	{ 'Peso Liquido'																, .T. }, ; //X3_DESCRIC
	{ 'Peso Liquido'																, .T. }, ; //X3_DESCSPA
	{ 'Peso Liquido'																, .T. }, ; //X3_DESCENG
	{ '@E 999,999.99'														, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'ZL6'																	, .T. }, ; //X3_ARQUIVO
	{ '17'																	, .T. }, ; //X3_ORDEM
	{ 'ZL6_RETNFE'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 200																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Retorno XML'															, .T. }, ; //X3_TITULO
	{ 'Retorno XML'															, .T. }, ; //X3_TITSPA
	{ 'Retorno XML'															, .T. }, ; //X3_TITENG
	{ 'Retorno XML'															, .T. }, ; //X3_DESCRIC
	{ 'Retorno XML'															, .T. }, ; //X3_DESCSPA
	{ 'Retorno XML'															, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'ZL6'																	, .T. }, ; //X3_ARQUIVO
	{ '19'																	, .T. }, ; //X3_ORDEM
	{ 'ZL6_TPMOV'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Tipo Mov.'															, .T. }, ; //X3_TITULO
	{ 'Tipo Mov.'															, .T. }, ; //X3_TITSPA
	{ 'Tipo Mov.'															, .T. }, ; //X3_TITENG
	{ 'Tipo Mov.'															, .T. }, ; //X3_DESCRIC
	{ 'Tipo Mov.'															, .T. }, ; //X3_DESCSPA
	{ 'Tipo Mov.'															, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
    ...
    aAdd( aSX3, { ;
        { 'ZL6'																	, .T. }, ; //X3_ARQUIVO
    { '20'																	, .T. }, ; //X3_ORDEM
    { 'ZL6_EMPODE'															, .T. }, ; //X3_CAMPO
    { 'C'																	, .T. }, ; //X3_TIPO
    { 2																		, .T. }, ; //X3_TAMANHO
    { 0																		, .T. }, ; //X3_DECIMAL
    { 'Emp.Ori.Dest.'															, .T. }, ; //X3_TITULO
    { 'Emp.Ori.Dest.'															, .T. }, ; //X3_TITSPA
    { 'Emp.Ori.Dest.'															, .T. }, ; //X3_TITENG
    { 'Emp.Ori.Dest.'															, .T. }, ; //X3_DESCRIC
    { 'Emp.Ori.Dest.'															, .T. }, ; //X3_DESCSPA
    { 'Emp.Ori.Dest.'															, .T. }, ; //X3_DESCENG
    { ''																	, .T. }, ; //X3_PICTURE
    { ''																	, .T. }, ; //X3_VALID
    { Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
        Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
    ...
    aAdd( aSX3, { ;
        { 'ZL6'																	, .T. }, ; //X3_ARQUIVO
    { '21'																	, .T. }, ; //X3_ORDEM
    { 'ZL6_FILODE'															, .T. }, ; //X3_CAMPO
    { 'C'																	, .T. }, ; //X3_TIPO
    { 2																		, .T. }, ; //X3_TAMANHO
    { 0																		, .T. }, ; //X3_DECIMAL
    { 'Fil.Ori.Dest.'															, .T. }, ; //X3_TITULO
    { 'Fil.Ori.Dest.'															, .T. }, ; //X3_TITSPA
    { 'Fil.Ori.Dest.'															, .T. }, ; //X3_TITENG
    { 'Fil.Ori.Dest.'															, .T. }, ; //X3_DESCRIC
    { 'Fil.Ori.Dest.'															, .T. }, ; //X3_DESCSPA
    { 'Fil.Ori.Dest.'															, .T. }, ; //X3_DESCENG
    { ''																	, .T. }, ; //X3_PICTURE
    { ''																	, .T. }, ; //X3_VALID
    { Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
        Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'ZL6'																	, .T. }, ; //X3_ARQUIVO
	{ '22'																	, .T. }, ; //X3_ORDEM
	{ 'ZL6_PEDODE'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 6																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Ped. Ori.Dest.'														, .T. }, ; //X3_TITULO
	{ 'Ped. Ori.Dest.'														, .T. }, ; //X3_TITSPA
	{ 'Ped. Ori.Dest.'														, .T. }, ; //X3_TITENG
	{ 'Ped. Ori.Dest.'														, .T. }, ; //X3_DESCRIC
	{ 'Ped. Ori.Dest.'														, .T. }, ; //X3_DESCSPA
	{ 'Ped. Ori.Dest.'														, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'ZL6'																	, .T. }, ; //X3_ARQUIVO
	{ '23'																	, .T. }, ; //X3_ORDEM
	{ 'ZL6_DOCODE'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 9																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Doc. Ori.Dest.'														, .T. }, ; //X3_TITULO
	{ 'Doc. Ori.Dest.'														, .T. }, ; //X3_TITSPA
	{ 'Doc. Ori.Dest.'														, .T. }, ; //X3_TITENG
	{ 'Doc. Ori.Dest.'														, .T. }, ; //X3_DESCRIC
	{ 'Doc. Ori.Dest.'														, .T. }, ; //X3_DESCSPA
	{ 'Doc. Ori.Dest.'														, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'ZL6'																	, .T. }, ; //X3_ARQUIVO
	{ '24'																	, .T. }, ; //X3_ORDEM
	{ 'ZL6_SERODE'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 3																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Serie Ori.Dest.'														, .T. }, ; //X3_TITULO
	{ 'Serie Ori.Dest.'														, .T. }, ; //X3_TITSPA
	{ 'Serie Ori.Dest.'														, .T. }, ; //X3_TITENG
	{ 'Serie Ori.Dest.'														, .T. }, ; //X3_DESCRIC
	{ 'Serie Ori.Dest.'														, .T. }, ; //X3_DESCSPA
	{ 'Serie Ori.Dest.'														, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSIX, { ;
	'ZL5'																	, ; //INDICE
	'1'																		, ; //ORDEM
	'ZL5_FILIAL+ZL5_CODEMP+ZL5_CODFIL+ZL5_NUM'								, ; //CHAVE
...
aAdd( aSIX, { ;
	'ZL6'																	, ; //INDICE
	'1'																		, ; //ORDEM
	'ZL6_FILIAL+ZL6_CODEMP+ZL6_CODFIL+ZL6_NUM'								, ; //CHAVE
	'Empresa+Filial+Pedido'													, ; //DESCRICAO
	'Empresa+Filial+Pedido'													, ; //DESCSPA
	'Empresa+Filial+Pedido'													, ; //DESCENG
	'U'																		, ; //PROPRI
...
aAdd( aSIX, { ;
	'ZL6'																	, ; //INDICE
	'2'																		, ; //ORDEM
	'ZL6_FILIAL+ZL6_CODEMP+ZL6_CODFIL+ZL6_PLACA+ZL6_QTDVEN'					, ; //CHAVE
	'Empresa+Filial+Placa+Quantidade'										, ; //DESCRICAO
	'Empresa+Filial+Placa+Quantidade'										, ; //DESCSPA
	'Empresa+Filial+Placa+Quantidade'										, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'N'																		} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	'ZL6'																	, ; //INDICE
	'3'																		, ; //ORDEM
	'ZL6_FILIAL+ZL6_CODEMP+ZL6_CODFIL+ZL6_NUM+ZL6_DOC+ZL6_SERIE'			, ; //CHAVE
	'Empresa+Filial+Pedido+Documento+Serie'									, ; //DESCRICAO
	'Empresa+Filial+Pedido+Documento+Serie'									, ; //DESCSPA
	'Empresa+Filial+Pedido+Documento+Serie'									, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'N'																		} ) //SHOWPESQ
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPDZL5" ) ) ) ;
