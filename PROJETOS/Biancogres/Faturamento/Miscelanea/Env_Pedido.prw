...
STATIC Function CRIA_EMAIL() 
	...
	DO CASE
		CASE cEmpAnt = "01"
		C_HTML += '  <th scope="col"><div align="center">PEDIDO DE VENDA NA EMPRESA BIANCOGRES - '+(SC5->C5_NUM)+IIF(_lVitcer,' - PARA ATENDER PEDIDO RODAP… DA VITCER No:'+_cPedVit,'')+'<br>'			
		CASE cEmpAnt = "05"   
	...
	C_HTML += '    <th width="40" scope="col"> PRE«O </span></th> '    
	...
	C_HTML += '<font color="black" size="2"> ' 
	C_HTML += '<tr> ' 	
	C_HTML += '    <th width="800" scope="col"> SEGURO PRODUTO: '+IIF(_AUX_PEDIDO->C5_VLRFRET == 0,'N√O','SIM') +'</span></th> ' 
