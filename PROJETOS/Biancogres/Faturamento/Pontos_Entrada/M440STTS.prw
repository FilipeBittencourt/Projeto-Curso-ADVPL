...
//TICKET - https://suporteti.biancogres.com.br/Ticket/Edit/31884
If AddDiasPVLib() == .F.
	Alert("Função - AddDiasPV - Fonte: Ma440VLD")
Return(.F.)
EndIf
...
Static Function AddDiasPV(C5NUM)

	IF ( AllTrim(cEmpAnt) $ "01" ) .And. M->C5_TIPO == 'N'
