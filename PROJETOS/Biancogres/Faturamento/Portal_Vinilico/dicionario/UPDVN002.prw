...
/*/
//--------------------------------------------------------------------
User Function UPDVN002( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "DELTABI" )
				Else
					MsgStop( "Atualização não Realizada.", "DELTABI" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	{ 'SC5'																	, .T. }, ; //X3_ARQUIVO
	{ 'EG'																	, .T. }, ; //X3_ORDEM
	{ 'C5_YDELTBI'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 19																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Delta BI'															, .T. }, ; //X3_TITULO
	{ 'Delta BI'															, .T. }, ; //X3_TITSPA
	{ 'Delta BI'															, .T. }, ; //X3_TITENG
	{ 'Delta BI'															, .T. }, ; //X3_DESCRIC
	{ 'Delta BI'															, .T. }, ; //X3_DESCSPA
	{ 'Delta BI'															, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "DELTABI" ) ) ) ;
