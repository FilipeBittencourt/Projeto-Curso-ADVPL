...
Static Function ReportDef()
	...
	TRCell():New(oSection1,'DT_NEC_REAL'	,,'Dt Neces. Real.'/*Titulo*/,/*Picture*/,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/)
	...
	oSection1:Cell('DT_NEC_REAL'  	):oFontBody := oFont1
...
Static Function ReportPrint(oReport)
	...
	oSection1:Cell('DT_NEC_REAL'  	):SetValue(CVALTOCHAR(STOD(CTRAB->C6_YDTNERE)))
