...
/*/
//--------------------------------------------------------------------
User Function UPDTAF03( cEmpAmb, cFilAmb ) 

Local   aSay      := {}
Local   aButton   := {}
Local   aMarcadas := {}
Local   cTitulo   := "ATUALIZAÇÃO DE DICIONÁRIOS E TABELAS DO SISTEMA (SX3)"
Local   cDesc1    := "Projeto: Automacao Fianceira " 
Local   cDesc2    := "Autor: Facile - Data: 19/12/2018" 
Local   cDesc3    := ""
Local   cDesc4    := "Descrição: Preenchimento endereco automatico pelo CEP"
Local   cDesc5    := "Item.....: CEP Clientes."
Local   cDesc6    := ""
Local   cDesc7    := ""
Local   cMsg      := ""
Local   lOk       := .F.
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDTAF03" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDTAF03" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ 'IIF(FindFunction("U_BIACEP"), U_BIACEP(.T.), .T.)'					, .T. }, ; //X3_WHEN
	{ ''																	, .T. }, ; //X3_INIBRW
	{ ''																	, .T. }, ; //X3_GRPSXG
	{ '1'																	, .T. }, ; //X3_FOLDER
	{ ''																	, .T. }, ; //X3_CONDSQL
...
aAdd( aSX3, { ;
	...
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Estado'																, .T. }, ; //X3_TITULO
	{ 'Est.Cliente'															, .T. }, ; //X3_TITSPA
	{ 'State'																, .T. }, ; //X3_TITENG
	{ 'Estado do cliente'													, .T. }, ; //X3_DESCRIC
	{ 'Estado del Cliente'													, .T. }, ; //X3_DESCSPA
	{ 'Customer State'														, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ 'ExistCpo("SX5","12"+M->A1_EST) .AND. IE(M->A1_INSCR,M->A1_EST)'		, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	{ 'SA1'																	, .T. }, ; //X3_ARQUIVO
	{ '12'																	, .T. }, ; //X3_ORDEM
	{ 'A1_COD_MUN'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 5																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Cd.Municipio'														, .T. }, ; //X3_TITULO
	{ 'Cd.Municipio'														, .T. }, ; //X3_TITSPA
	{ 'City Code'															, .T. }, ; //X3_TITENG
	{ 'C¢digo do Municipio'													, .T. }, ; //X3_DESCRIC
	{ 'Codigo del Municipio'												, .T. }, ; //X3_DESCSPA
	{ 'City Code'															, .T. }, ; //X3_DESCENG
	{ '@99999'																, .T. }, ; //X3_PICTURE
	{ 'ExistCpo("CC2",M->A1_EST+M->A1_COD_MUN)'								, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	...
	{ 'Municipality'														, .T. }, ; //X3_TITENG
	{ 'Municipio do cliente'												, .T. }, ; //X3_DESCRIC
	{ 'Municipio del cliente'												, .T. }, ; //X3_DESCSPA
	{ 'Customer Municipality'												, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 'Barrio del cliente'													, .T. }, ; //X3_DESCSPA
	{ 'Customer District'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 'Cod Enderecamento Postal'											, .T. }, ; //X3_DESCRIC
	{ 'Cod Direccion Postal'												, .T. }, ; //X3_DESCSPA
	...
	{ ''																	, .T. }, ; //X3_CONTEXT
	{ '€'																	, .T. }, ; //X3_OBRIGAT
	{ 'NaoVazio() .And. IIF(FindFunction("U_BIACEP"), U_BIACEP(.F., "SA1", "M->A1_CEP"), .T.)'	, .T. }, ; //X3_VLDUSER
	{ ''																	, .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	...
	{ 15																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Mun. Cobr.'															, .T. }, ; //X3_TITULO
	{ 'Ciud.Cobr.'															, .T. }, ; //X3_TITSPA
	{ 'Coll. City'															, .T. }, ; //X3_TITENG
	{ 'Municipio de Cobranca'												, .T. }, ; //X3_DESCRIC
	{ 'Municipio de Cobro'													, .T. }, ; //X3_DESCSPA
	{ 'Collection City'														, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 2																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Uf de Cobr.'															, .T. }, ; //X3_TITULO
	{ 'Estad.Cobro'															, .T. }, ; //X3_TITSPA
	{ 'State f/ Inv'														, .T. }, ; //X3_TITENG
	{ 'Uf de Cobranca'														, .T. }, ; //X3_DESCRIC
	{ 'Est. de Cobro'														, .T. }, ; //X3_DESCSPA
	{ 'State for Invoicing'													, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 8																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Cep de Cobr.'														, .T. }, ; //X3_TITULO
	{ 'CP de Cobr.'															, .T. }, ; //X3_TITSPA
	{ 'Coll. Zip Cd'														, .T. }, ; //X3_TITENG
	{ 'Cep de Cobranca'														, .T. }, ; //X3_DESCRIC
	{ 'CP de Cobranza'														, .T. }, ; //X3_DESCSPA
	{ 'Collection Zip Code'													, .T. }, ; //X3_DESCENG
	{ '@R 99999-999'														, .T. }, ; //X3_PICTURE
	{ 'A030Cep("C")'														, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
	...
	{ ''																	, .T. }, ; //X3_CONTEXT
	{ '€'																	, .T. }, ; //X3_OBRIGAT
	{ 'NaoVazio() .And. IIF(FindFunction("U_BIACEP"), U_BIACEP(.F., "SA1", "M->A1_CEPC"), .T.)'	, .T. }, ; //X3_VLDUSER
	{ ''																	, .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	{ 'SA1'																	, .T. }, ; //X3_ARQUIVO
	{ 'D5'																	, .T. }, ; //X3_ORDEM
	{ 'A1_BAIRROE'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 20																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Bairro Entr.'														, .T. }, ; //X3_TITULO
	{ 'Barrio Entr.'														, .T. }, ; //X3_TITSPA
	{ 'Deliv.Distr.'														, .T. }, ; //X3_TITENG
	{ 'Bairro de Entrega'													, .T. }, ; //X3_DESCRIC
	{ 'Barrio de Entrega'													, .T. }, ; //X3_DESCSPA
	{ 'District for delivery'												, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 8																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Cep Entr'															, .T. }, ; //X3_TITULO
	{ 'CP Entr'																, .T. }, ; //X3_TITSPA
	{ 'Del. Zip Cd.'														, .T. }, ; //X3_TITENG
	{ 'Cep de Entrega'														, .T. }, ; //X3_DESCRIC
	{ 'CP de Entrega'														, .T. }, ; //X3_DESCSPA
	{ 'Delivery Zip Code'													, .T. }, ; //X3_DESCENG
	{ '@R 99999-999'														, .T. }, ; //X3_PICTURE
	{ 'A030Cep("E")'														, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
	...
	{ ''																	, .T. }, ; //X3_CONTEXT
	{ ''																	, .T. }, ; //X3_OBRIGAT
	{ 'NaoVazio() .And. IIF(FindFunction("U_BIACEP"), U_BIACEP(.F.,"SA1", "M->A1_CEPE"), .T.)'	, .T. }, ; //X3_VLDUSER
	{ ''																	, .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	...
	{ 15																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Mun. entr'															, .T. }, ; //X3_TITULO
	{ 'Ciud.Entr.'															, .T. }, ; //X3_TITSPA
	{ 'Del. City'															, .T. }, ; //X3_TITENG
	{ 'Municipio de Entrega'												, .T. }, ; //X3_DESCRIC
	{ 'Ciudad de Entrega'													, .T. }, ; //X3_DESCSPA
	{ 'City for Delivery'													, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Uf Entr'																, .T. }, ; //X3_TITULO
	{ 'E/P/R Entreg'														, .T. }, ; //X3_TITSPA
	{ 'Deliv.State'															, .T. }, ; //X3_TITENG
	{ 'Estado de Entrega'													, .T. }, ; //X3_DESCRIC
	{ 'Estado de Entrega'													, .T. }, ; //X3_DESCSPA
	{ 'State of Delivery'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ "Vazio() .Or. ExistCpo('SX5','12'+M->A1_ESTE)"						, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	{ 'SA1'																	, .T. }, ; //X3_ARQUIVO
	{ 'P5'																	, .T. }, ; //X3_ORDEM
	{ 'A1_COMPLEM'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 50																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Complemento'															, .T. }, ; //X3_TITULO
	{ 'Complemento'															, .T. }, ; //X3_TITSPA
	{ 'Complement'															, .T. }, ; //X3_TITENG
	{ 'Complemento do endereco'												, .T. }, ; //X3_DESCRIC
	{ 'Complemento de la direcc.'											, .T. }, ; //X3_DESCSPA
	{ 'Address complement'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SA1'																	, .T. }, ; //X3_ARQUIVO
	{ 'R2'																	, .T. }, ; //X3_ORDEM
	{ 'A1_CODMUNE'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 5																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Cd Mun Entre'														, .T. }, ; //X3_TITULO
	{ 'Cd Mun Entre'														, .T. }, ; //X3_TITSPA
	{ 'Del.City Cd;'														, .T. }, ; //X3_TITENG
	{ 'Municipio da Entrega'												, .T. }, ; //X3_DESCRIC
	{ 'Municipio da Entrega'												, .T. }, ; //X3_DESCSPA
	{ 'Delivery City'														, .T. }, ; //X3_DESCENG
	{ '@9'																	, .T. }, ; //X3_PICTURE
	{ 'Vazio() .Or. ExistCpo("CC2",M->A1_ESTE+M->A1_CODMUNE)'				, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	{ 'SA1'																	, .T. }, ; //X3_ARQUIVO
	{ 'U1'																	, .T. }, ; //X3_ORDEM
	{ 'A1_YCODMUN'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 5																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Cd.Mun.Cobr.'														, .T. }, ; //X3_TITULO
	{ 'Cd.Mun.Cobr.'														, .T. }, ; //X3_TITSPA
	{ 'Cd.Mun.Cobr.'														, .T. }, ; //X3_TITENG
	{ 'Cod. Municipio Cobr.'												, .T. }, ; //X3_DESCRIC
	{ 'Cod. Municipio Cobr.'												, .T. }, ; //X3_DESCSPA
	{ 'Cod. Municipio Cobr.'												, .T. }, ; //X3_DESCENG
	{ '@99999'																, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	{ 'R'																	, .T. }, ; //X3_CONTEXT
	{ ''																	, .T. }, ; //X3_OBRIGAT
	{ 'ExistCpo("CC2",M->A1_ESTC+M->A1_YCODMUN)'							, .T. }, ; //X3_VLDUSER
	{ ''																	, .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
...
aAdd( aSX7, { ;
	'A1_CEP'																, ; //X7_CAMPO
	'001'																	, ; //X7_SEQUENC
	'IIF(GetNewPar("MV_YVLDCEP", .T.) .And. !IsBlind(), M->A1_CEPC, IIF(INCLUI, M->A1_CEP, M->A1_CEPC))'	, ; //X7_REGRA
	'A1_CEPC'																, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	''																		, ; //X7_ALIAS
...
aAdd( aSX7, { ;
	'A1_CEP'																, ; //X7_CAMPO
	'002'																	, ; //X7_SEQUENC
	'IIF(INCLUI, M->A1_COD_MUN, M->A1_YCODMUN)'							, ; //X7_REGRA
	'A1_YCODMUN'															, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	''																		, ; //X7_ALIAS
	0																		, ; //X7_ORDEM
...
aAdd( aSX7, { ;
	'A1_COD_MUN'															, ; //X7_CAMPO
	'003'																	, ; //X7_SEQUENC
	'IIF(INCLUI, CC2->CC2_MUN, M->A1_MUNC)'								, ; //X7_REGRA
	'A1_MUNC'																, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'S'																		, ; //X7_SEEK
	'CC2'																	, ; //X7_ALIAS
	1																		, ; //X7_ORDEM
	'xFilial("CC2")+M->A1_EST+M->A1_COD_MUN'								, ; //X7_CHAVE
	'U'																		, ; //X7_PROPRI
	''																		} ) //X7_CONDIC
...
aAdd( aSX7, { ;
	'A1_COD_MUN'															, ; //X7_CAMPO
	'004'																	, ; //X7_SEQUENC
	'IIF(INCLUI, CC2->CC2_MUN, M->A1_YCODMUN)'							, ; //X7_REGRA
	'A1_YCODMUN'															, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'S'																		, ; //X7_SEEK
	'CC2'																	, ; //X7_ALIAS
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPDTAF03" ) ) ) ;
