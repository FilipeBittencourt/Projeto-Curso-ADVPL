...
/*/
//--------------------------------------------------------------------
User Function BIAF172( cEmpAmb, cFilAmb )
Local   aSay      := {}
Local   aButton   := {}
Local   aMarcadas := {}
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "TKT2565X" )
				Else
					MsgStop( "Atualização não Realizada.", "TKT2565X" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	{ 'SE2'																	, .T. }, ; //X3_ARQUIVO
	{ '16'																	, .T. }, ; //X3_ORDEM
	{ 'E2_YMOEDA'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Moeda CT'															, .T. }, ; //X3_TITULO
	{ 'Moneda'																, .T. }, ; //X3_TITSPA
	...
	{ ''																	, .T. }, ; //X3_OBRIGAT
	{ ''																	, .T. }, ; //X3_VLDUSER
	{ '1=Real;2=Dólar;3=Euro;4=Libra'		  , .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ ''																	, .T. }, ; //X3_WHEN
...
aAdd( aSX3, { ;
	{ 'SE2'																	, .T. }, ; //X3_ARQUIVO
	{ '17'																	, .T. }, ; //X3_ORDEM
	{ 'E2_YVLMOED'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 12																	, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Vl Moeda CT'															, .T. }, ; //X3_TITULO
	{ 'Moneda'																, .T. }, ; //X3_TITSPA
	{ 'Currency'															, .T. }, ; //X3_TITENG
	{ 'Moeda do Titulo'														, .T. }, ; //X3_DESCRIC
	{ 'Moneda del Titulo'													, .T. }, ; //X3_DESCSPA
...
aAdd( aSX3, { ;
	{ 'SE2'																	, .T. }, ; //X3_ARQUIVO
	{ '18'																	, .T. }, ; //X3_ORDEM
	{ 'E2_YTXMOED'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 11																	, .T. }, ; //X3_TAMANHO
	{ 4																		, .T. }, ; //X3_DECIMAL
	{ 'Taxa moeda C'														, .T. }, ; //X3_TITULO
...
aAdd( aSX3, { ;
	{ 'SA1'																	, .T. }, ; //X3_ARQUIVO
	{ 'Z9'																	, .T. }, ; //X3_ORDEM
	{ 'A1_YVENSUF'															, .T. }, ; //X3_CAMPO
	{ 'D'																	, .T. }, ; //X3_TIPO
	{ 8																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Venc.Sufr.'															, .T. }, ; //X3_TITULO
	{ 'Venc.Sufr.'															, .T. }, ; //X3_TITSPA
	{ 'Venc.Sufr.'															, .T. }, ; //X3_TITENG
	{ 'Vencimento Suframa'												    , .T. }, ; //X3_DESCRIC
	{ 'Vencimento Suframa'													, .T. }, ; //X3_DESCSPA
	{ 'Vencimento Suframa'													, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SA1'																	, .T. }, ; //X3_ARQUIVO
	{ 'Z9'																	, .T. }, ; //X3_ORDEM
	{ 'A1_YTRIDIF'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Tr.Tri.Dif'															, .T. }, ; //X3_TITULO
	{ 'Tr.Tri.Dif'															, .T. }, ; //X3_TITSPA
	{ 'Tr.Tri.Dif'															, .T. }, ; //X3_TITENG
	{ 'Trat.Trib.Dif.'												    	, .T. }, ; //X3_DESCRIC
	{ 'Trat.Trib.Dif.'														, .T. }, ; //X3_DESCSPA
	{ 'Trat.Trib.Dif.'														, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SA1'																	, .T. }, ; //X3_ARQUIVO
	{ 'Z9'																	, .T. }, ; //X3_ORDEM
	{ 'A1_YVCTDIF'															, .T. }, ; //X3_CAMPO
	{ 'D'																	, .T. }, ; //X3_TIPO
	{ 8																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Vc.Tri.Dif'															, .T. }, ; //X3_TITULO
	{ 'Vc.Tri.Dif'															, .T. }, ; //X3_TITSPA
	{ 'Vc.Tri.Dif'															, .T. }, ; //X3_TITENG
	{ 'Venc.Trib.Dif.'												    	, .T. }, ; //X3_DESCRIC
	{ 'Venc.Trib.Dif.'														, .T. }, ; //X3_DESCSPA
	{ 'Venc.Trib.Dif.'														, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX7, { ;
	...
	''																		, ; //X7_CHAVE
	'U'																		, ; //X7_PROPRI
	'M->E2_YMOEDA  == "1"'													} ) //X7_CONDIC

aAdd( aSX7, { ;
	'E2_YMOEDA'																, ; //X7_CAMPO
	'002'																	, ; //X7_SEQUENC
	'0'																		, ; //X7_REGRA
	'E2_YVLMOED'															, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	''																		, ; //X7_ALIAS
	0																		, ; //X7_ORDEM
...
aAdd( aSX7, { ;
	'E2_YTXMOED'															, ; //X7_CAMPO
	'001'																	, ; //X7_SEQUENC
	'NoRound(M->E2_YVLMOEDA * M->E2_YTXMOED)'								, ; //X7_REGRA
	'E2_VALOR'																, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	''																		, ; //X7_ALIAS
...
aAdd( aHlpPor, 'Moedas de 2 a 5 = Conforme cadastrado' )
aAdd( aHlpPor, 'noparâmetro MV_MOEDAx.' )

aHlpEng := {}

aHlpSpa := {}

PutSX1Help( "PE2_YMOEDA ", aHlpPor, aHlpEng, aHlpSpa, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "E2_YMOEDA" )
...
PutSX1Help( "PE2_YTXMOED", aHlpPor, aHlpEng, aHlpSpa, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "E2_YTXMOED" )
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "TKT2565X" ) ) ) ;
