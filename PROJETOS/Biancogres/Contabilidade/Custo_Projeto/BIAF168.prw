...
User Function BIAF168(cEmpAmb, cFilAmb)
Local   aSay      := {}
Local   aButton   := {}
Local   aMarcadas := {}
...
aAdd( aSX2, { ;
	...
	cPath																	, ; //X2_PATH
	'ZMC010'																, ; //X2_ARQUIVO
	'Orçamento Clvl'													, ; //X2_NOME
	'Orçamento Clvl'													, ; //X2_NOMESPA
	'Orçamento Clvl'													, ; //X2_NOMEENG
	'C'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX2, { ;
	...
	cPath																	, ; //X2_PATH
	'ZMD010'																, ; //X2_ARQUIVO
	'Orçamento Clvl Item'																, ; //X2_NOME
	'Orçamento Clvl Item'																, ; //X2_NOMESPA
	'Orçamento Clvl Item'																, ; //X2_NOMEENG
	'C'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX2, { ;
	...
	cPath																	, ; //X2_PATH
	'ZME010'																, ; //X2_ARQUIVO
	'Unidade Medida Contrato'												, ; //X2_NOME
	'Unidade Medida Contrato'												, ; //X2_NOMESPA
	'Unidade Medida Contrato'												, ; //X2_NOMEENG
	'C'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX3, { ;
	...
	{ "GETSXENUM('ZMC', 'ZMC_CODIGO')"										, .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 0																		, .T. }, ; //X3_NIVEL
	{ Chr(254) + Chr(192)													, .T. }, ; //X3_RESERV
	{ ''																	, .T. }, ; //X3_CHECK
...
aAdd( aSX3, { ;
	...
	{ 'R'																	, .T. }, ; //X3_CONTEXT
	{ '€'																	, .T. }, ; //X3_OBRIGAT
	{ 'ExistCpo("CTH", M->ZMC_CLVL)'										, .T. }, ; //X3_VLDUSER
	{ ''																	, .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	...
	{ 'R'																	, .T. }, ; //X3_CONTEXT
	{ '€'																	, .T. }, ; //X3_OBRIGAT
	{ 'ExistCpo("CTD", M->ZMC_ITEMCT)'										, .T. }, ; //X3_VLDUSER
	{ ''																	, .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	...
	{ 'Unidade'																, .T. }, ; //X3_TITSPA
	{ 'Unidade'																, .T. }, ; //X3_TITENG
	{ 'Unidade'																, .T. }, ; //X3_DESCRIC
	{ 'Unidade'																, .T. }, ; //X3_DESCSPA
	{ 'Unidade'																, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ '1=Real;2=Dolar;3=Libra;4=Euro'										, .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ ''																	, .T. }, ; //X3_WHEN
...
aAdd( aSX3, { ;
	{ 'ZMD'																	, .T. }, ; //X3_ARQUIVO
	{ '10'																	, .T. }, ; //X3_ORDEM
	{ 'ZMD_CPENC'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Comp. Encerr'														, .T. }, ; //X3_TITULO
	{ 'Comp. Encerr'														, .T. }, ; //X3_TITSPA
	{ 'Comp. Encerr'														, .T. }, ; //X3_TITENG
	{ 'Compra Encerrada'													, .T. }, ; //X3_DESCRIC
	{ 'Compra Encerrada'													, .T. }, ; //X3_DESCSPA
	{ 'Compra Encerrada'													, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 2																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Codigo UM'															, .T. }, ; //X3_TITULO
	{ 'Codigo UM'															, .T. }, ; //X3_TITSPA
	{ 'Codigo UM'															, .T. }, ; //X3_TITENG
	{ 'Codigo Unidade Medida'												, .T. }, ; //X3_DESCRIC
	{ 'Codigo Unidade Medida'												, .T. }, ; //X3_DESCSPA
	{ 'Codigo Unidade Medida'												, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	{ 'R'																	, .T. }, ; //X3_CONTEXT
	{ '€'																	, .T. }, ; //X3_OBRIGAT
	{ 'ExistChav("ZME",M->ZME_UM)'											, .T. }, ; //X3_VLDUSER
	{ ''																	, .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'DB'																	, ; //XB_COLUNA
	'Unid Medida Contrato'													, ; //XB_DESCRI
	'Unid Medida Contrato'													, ; //XB_DESCSPA
	'Unid Medida Contrato'													, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'ZME'																	} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_COLUNA
	'Codigo Um'																, ; //XB_DESCRI
	'Codigo Um'																, ; //XB_DESCSPA
	'Codigo Um'																, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	''																		} ) //XB_CONTEM
