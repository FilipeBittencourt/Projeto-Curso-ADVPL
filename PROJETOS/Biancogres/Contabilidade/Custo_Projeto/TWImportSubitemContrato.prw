...
// TITULOS DAS JANELAS
#DEFINE TIT_MAIN_WND "Importação de Subitem de Contrato"
...
#DEFINE TIT_COL3_BRW_FILE "Subitem"
#DEFINE TIT_COL4_BRW_FILE "Descrição"
...
Class TWImportSubitemContrato From LongClassName
...
Method New() Class TWImportSubitemContrato
	...
	::oBusiness := TImportSubitemContrato():New()
...
Method LoadInterface() Class TWImportSubitemContrato
...
Method LoadDialog() Class TWImportSubitemContrato
...
Method LoadLayer() Class TWImportSubitemContrato
...
// Carrega Linha Acima
Method LoadLineUp() Class TWImportSubitemContrato
...
Method LoadLineDown() Class TWImportSubitemContrato
	...
	::oBrwFile:AddColumn(TcColumn():New(TIT_COL3_BRW_FILE, {|| ::aFile[::oBrwFile:nAt, IDX_SUBITEM] }, "@!",nil,nil,nil,35,.F.,.F.,nil,nil,nil,.F.,nil))	
	::oBrwFile:AddColumn(TcColumn():New(TIT_COL4_BRW_FILE, {|| ::aFile[::oBrwFile:nAt, IDX_DESCRICAO] }, "@!",nil,nil,nil,200,.F.,.F.,nil,nil,nil,.F.,nil))		
...
Method Activate() Class TWImportSubitemContrato
...
Method Refresh() Class TWImportSubitemContrato
...
Method LoadFile() Class TWImportSubitemContrato
...
Method ImportFile() Class TWImportSubitemContrato
...
Method VldFile() Class TWImportSubitemContrato
Local lRet := .F.
