...
@version 1.0
@Projet A-35
@description DRE - Percentual / Valor para apuração do DRE. 
@type Program
/*/
...
User Function BIA628()
	...
	Define MsDialog _oDlg Title "DRE - Percentual / Valor para apuração do DRE" From _aSize[7],0 To _aSize[6],_aSize[5] Of oMainWnd Pixel
...
¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦
¦¦+-----------------------------------------------------------------------+¦¦
¦¦¦Funçao    ¦ B628IEXC ¦ Autor ¦ Marcos Alberto S      ¦ Data ¦ 21/06/17 ¦¦¦
¦¦+----------+------------------------------------------------------------¦¦¦
...
User Function B628IEXC()
	...
	AADD(aSays, OemToAnsi("Rotina para importação dos ajustes orçamentário direto para a tabela ZOC."))   
