...
static function MenuDef() as array
    ...
    ADD OPTION aRotina TITLE "Visualizar"       ACTION "VIEWDEF.BIA637MVCGRID"  OPERATION MODEL_OPERATION_VIEW   ACCESS 0 //OPERATION 2
    ADD OPTION aRotina TITLE "Incluir"          ACTION "VIEWDEF.BIA637MVCGRID"  OPERATION MODEL_OPERATION_INSERT ACCESS 0 //OPERATION 3
    ADD OPTION aRotina TITLE "Alterar"          ACTION "VIEWDEF.BIA637MVCGRID"  OPERATION MODEL_OPERATION_UPDATE ACCESS 0 //OPERATION 4
    ADD OPTION aRotina TITLE "Excluir"          ACTION "VIEWDEF.BIA637MVCGRID"  OPERATION MODEL_OPERATION_DELETE ACCESS 0 //OPERATION 5
    ADD OPTION aRotina TITLE "Processar"        ACTION "U_BIA637Proc"           OPERATION MODEL_OPERATION_INSERT ACCESS 0 //OPERATION 3
    ADD OPTION aRotina TITLE "Exportar Excel"   ACTION "U_BIA637Excel"          OPERATION MODEL_OPERATION_VIEW   ACCESS 0 //OPERATION 2
...
static function ModelDef() as object
    ...
    oModel:=MPFormModel():New("BIA637MVCGRID",/*bPre*/,/*bPost*/,/*bCommit*/,/*bCancel*/)
    // Adiciona a descricao do Modelo de Dados
    oModel:SetDescription("Consolidado - BP Real (MesRef)")

    // Blocos de codigo do modelo
    bEvalVC:={|oModel,lValid|BIA637TTS(oModel,lValid)}
    ...
    oModel:AddFields("BIA637MVCGRID_HEADER",/*cOwner*/,oZODHeader,/*bLOkVld*/,/*bTOkVld*/,/*bCarga*/)
    ...
    oModel:GetModel("BIA637MVCGRID_HEADER"):SetPrimaryKey(aPK)

    // Adiciona a descricao do Componente do Modelo de Dados
    oModel:GetModel("BIA637MVCGRID_HEADER"):SetDescription("Cabecalho :: Consolidado - BP Real (MesRef)")

    // Cria a estrutura a ser usada no Modelo de Dados
    oZODDetail:=FWFormStruct(1,"ZOD",bDetail/*bAvalCampo*/,/*lViewUsado*/)

    // Adiciona Grid no modelo
    oModel:AddGrid("BIA637MVCGRID_DETAIL","BIA637MVCGRID_HEADER",oZODDetail,/*bLOkVld*/,/*bTOkVld*/,/*bCarga*/)
*TODO: Implementar o uso de aCols e aHeader no Grid
*    oModel:GetModel("BIA637MVCGRID_DETAIL"):SetUseOldGrid()

    // Adiciona a descricao do Componente do Modelo de Dados
    oModel:GetModel("BIA637MVCGRID_DETAIL"):SetDescription("Itens :: Consolidado - BP Real (MesRef)")
...
static function ViewDef() as object
    ...
    oModel:=FWLoadModel("BIA637MVCGRID")
    ...
    oView:AddField("VIEW_BIA637MVCGRID_HEADER",oZODHeader,"BIA637MVCGRID_HEADER")

    // Criar um "box" horizontal para receber algum elemento da view
    oView:CreateHorizontalBox("FORMFIELD_VIEW_BIA637MVCGRID_HEADER",30)

    // Relaciona o ID da View com o "box" para exibicao
    oView:SetOwnerView("VIEW_BIA637MVCGRID_HEADER","FORMFIELD_VIEW_BIA637MVCGRID_HEADER")

    // Cria a estrutura a ser usada na View
    oZODDetail:=FWFormStruct(2,"ZOD",bDetail/*bAvalCampo*/,/*lViewUsado*/)

    //Adiciona Grid na interface
    oView:AddGrid("VIEW_BIA637MVCGRID_DETAIL",oZODDetail,"BIA637MVCGRID_DETAIL")

    //Define campo com incremento automatico por Linha
*    oView:AddIncrementField("VIEW_BIA637MVCGRID_DETAIL","")

    // Criar um "box" horizontal para receber algum elemento da view
    oView:CreateHorizontalBox("FORMFIELD_VIEW_BIA637MVCGRID_DETAIL",70)

    // Relaciona o ID da View com o "box" para exibicao
    oView:SetOwnerView("VIEW_BIA637MVCGRID_DETAIL","FORMFIELD_VIEW_BIA637MVCGRID_DETAIL")
...
static function BIA637TTS(oModel as object,lIsInValid as logical) as logical

    local aSaveRows     as array

    local lBIA637TTS    as logical
    ...
    lBIA637TTS:=FWFormCommit(oModel)
