...
@since 30/10/2020
@version 1.0
@description Tela para cadastro dos % de Rec/Pis/Cof 
@type function
@Obs Projeto A-35
/*/
...
User Function BIA598()	
	...
	Local aNoFields     := {"ZO3_VERSAO", "ZO3_REVISA", "ZO3_ANOREF", "ZO3_LINHA"}
	...
	Define MsDialog _oDlg Title "Tela para cadastro dos % de Rec/Pis/Cof" From _aSize[7],0 To _aSize[6],_aSize[5] Of oMainWnd Pixel
	...
	_oGetDados := MsNewGetDados():New(_aPosObj[2,1], _aPosObj[2,2], _aPosObj[2,3], _aPosObj[2,4], 7, "U_B598LOK()" /*[ cLinhaOk]*/, /*[ cTudoOk]*/, /*[ cIniCpos]*/, /*Acpos*/, /*[ nFreeze]*/, 99999 /*[ nMax]*/, "U_B598TOK()" /*cFieldOK*/, /*[ cSuperDel]*/,"U_B598DOK()" /*[ cDelOk]*/, _oDlg, _aHeader, _aCols)
...
Static Function fBIA598A()
	...
	If !Empty(_cVersao) .and. !Empty(_cRevisa) .and. !Empty(_cAnoRef)
		...
		Processa({ || cMsg := fBIA598D() }, "Aguarde...", "Carregando dados...",.F.)
	EndIf
...
Static Function fBIA598D()
	...
	BeginSql Alias _cAlias
		...
		AND ZO3_ANOREF = %Exp:_cAnoRef%
		AND ZO3.%NotDel%
		ORDER BY ZO3_VERSAO, ZO3_REVISA, ZO3_ANOREF, ZO3_CTACUS, ZO3_CTAREC, ZO3_CTAPIS, ZO3_CTACOF
...
User Function B598TOK()
	...
	If !GDdeleted(_nAt)
		...
		Do Case
			...
			Case Alltrim(cMenVar) == "M->ZO3_CTACUS" .or. Alltrim(cMenVar) == "M->ZO3_CTAREC" .or. Alltrim(cMenVar) == "M->ZO3_CTAPIS" .or. Alltrim(cMenVar) == "M->ZO3_CTACOF"
			dbSelectArea("CT1")
			dbSetOrder(1)
			If !CT1->(dbSeek(xFilial("CT1") + &(Alltrim(cMenVar))))
				MsgINFO("Conta Contábil Inexistente. Informe um conta contábil válida!!!")
				Return(.F.)
			EndIf
