...
Static Function fProcessa(msFil, cVersao, cRevisa, cAnoRef, cMsg)
	...
	For nW := 1 To 12
		...
		cSql += "                                      ELSE 'AC00' "
		cSql += "                                  END "
		cSql += "                             ELSE SUBSTRING(ZF2_AGGRAT, 1, 4) "
		cSql += "                         END,  "
		...
		cSql += "              LEFT JOIN " + RetFullName("ZF2", cEmpAnt) + " ZF2 ON ZF2_FILIAL = '" + xFilial("ZF2") + "' "
		cSql += "                                              AND ZF2_CODIGO = CTH_YAGRAT "
		cSql += "                                              AND ZF2.D_E_L_E_T_ = ' ' "
		cSql += "         GROUP BY PERIODO,  "
		cSql += "                  APL,  "
		cSql += "                  CTA,  "
		cSql += "                  CT1_DESC01,  "
