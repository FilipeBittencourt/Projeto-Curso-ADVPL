...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDSC5" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDSC5" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	{ 'SC5'																	, .F. }, ; //X3_ARQUIVO
	{ '17'																	, .F. }, ; //X3_ORDEM
	{ 'C5_YSEGFAB'															, .F. }, ; //X3_CAMPO
	{ 'C'																	, .F. }, ; //X3_TIPO
	{ 1																		, .F. }, ; //X3_TAMANHO
	{ 0																		, .F. }, ; //X3_DECIMAL
	{ 'Seguro Fabr?'														, .F. }, ; //X3_TITULO
	{ 'Seguro Fabr?'														, .F. }, ; //X3_TITSPA
	{ 'Seguro Fabr?'														, .F. }, ; //X3_TITENG
	{ 'Seguro Fabricantre'													, .F. }, ; //X3_DESCRIC
	{ 'Seguro Fabricantre'													, .F. }, ; //X3_DESCSPA
	{ 'Seguro Fabricantre'													, .F. }, ; //X3_DESCENG
	{ '@!'																	, .F. }, ; //X3_PICTURE
	{ ''																	, .F. }, ; //X3_VALID
	...
	{ 'S=Sim;N=Não;'														, .F. }, ; //X3_CBOXSPA
	{ 'S=Sim;N=Não;'														, .F. }, ; //X3_CBOXENG
	{ ''																	, .F. }, ; //X3_PICTVAR
	{ 'INCLUI'																, .F. }, ; //X3_WHEN
	{ ''																	, .F. }, ; //X3_INIBRW
	{ ''																	, .F. }, ; //X3_GRPSXG
...
aAdd( aSX3, { ;
	{ 'SC5'																	, .F. }, ; //X3_ARQUIVO
	{ '18'																	, .F. }, ; //X3_ORDEM
	{ 'C5_PSEGFAB'															, .F. }, ; //X3_CAMPO
	{ 'N'																	, .F. }, ; //X3_TIPO
	{ 5																		, .F. }, ; //X3_TAMANHO
	{ 2																		, .F. }, ; //X3_DECIMAL
	{ '%Seguro Fab.'														, .F. }, ; //X3_TITULO
	{ '%Seguro Fab.'														, .F. }, ; //X3_TITSPA
	{ '%Seguro Fab.'														, .F. }, ; //X3_TITENG
	{ '%Seguro Fabricante'													, .F. }, ; //X3_DESCRIC
	{ '%Seguro Fabricante'													, .F. }, ; //X3_DESCSPA
	{ '%Seguro Fabricante'													, .F. }, ; //X3_DESCENG
...
aAdd( aSX3, { ;
	{ 'SC5'																	, .F. }, ; //X3_ARQUIVO
	{ '25'																	, .F. }, ; //X3_ORDEM
	{ 'C5_VLRFRET'															, .F. }, ; //X3_CAMPO
	{ 'N'																	, .F. }, ; //X3_TIPO
	{ 6																		, .F. }, ; //X3_TAMANHO
	{ 3																		, .F. }, ; //X3_DECIMAL
	{ 'Vlr. Seguro'															, .F. }, ; //X3_TITULO
	{ 'Vlr. Seguro'															, .F. }, ; //X3_TITSPA
	{ 'Vlr. Seguro'															, .F. }, ; //X3_TITENG
	{ 'Valor do Seguro'														, .F. }, ; //X3_DESCRIC
	{ 'Valor do Seguro'														, .F. }, ; //X3_DESCSPA
	{ 'Valor do Seguro'														, .F. }, ; //X3_DESCENG
	...
	{ ''																	, .F. }, ; //X3_CBOXENG
	{ ''																	, .F. }, ; //X3_PICTVAR
	{ '!IsInCallStack(' + DUPLAS  + 'U_M410RPRC' + DUPLAS  + ') .AND. M->C5_YSEGFAB <> ' + SIMPLES + 'S' + SIMPLES + '', .F. }, ; //X3_WHEN
	{ ''																	, .F. }, ; //X3_INIBRW
	{ ''																	, .F. }, ; //X3_GRPSXG
	{ ''																	, .F. }, ; //X3_FOLDER
	{ ''																	, .F. }, ; //X3_CONDSQL
...
aAdd( aSX7, { ;
	'C5_YSEGFAB'															, ; //X7_CAMPO
	'001'																	, ; //X7_SEQUENC
	'EXECBLOCK("BIAFS005", .F., .F.)'										, ; //X7_REGRA
	'C5_YSEGFAB'															, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	''																		, ; //X7_ALIAS
	0																		, ; //X7_ORDEM
...
aAdd( aSX7, { ;
	'C5_YSEGFAB'															, ; //X7_CAMPO
	'002'																	, ; //X7_SEQUENC
	'EXECBLOCK("ATU_PEDIDO", .F., .F.)'										, ; //X7_REGRA
	'C5_YSEGFAB'															, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	''																		, ; //X7_ALIAS
