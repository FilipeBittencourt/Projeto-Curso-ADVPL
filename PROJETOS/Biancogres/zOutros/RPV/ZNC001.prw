...
/*/
//--------------------------------------------------------------------
User Function ZNC001( cEmpAmb, cFilAmb )
  ...
  If lOk
    ...
    If !Empty( aMarcadas )
      If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
        ...
        If lAuto
          If lOk
            MsgStop( "Atualização Realizada.", "ZNC001" )
          Else
            MsgStop( "Atualização não Realizada.", "ZNC001" )
          EndIf
          dbCloseAll()
        Else
          If lOk
...
//
  aAdd( aSX2, { ;
    'ZNC'																	, ; //X2_CHAVE
  cPath																	, ; //X2_PATH
  'ZNC'+cEmpr																, ; //X2_ARQUIVO
  'RATEIO RPV'															, ; //X2_NOME
  'RATEIO RPV'															, ; //X2_NOMESPA
  'RATEIO RPV'															, ; //X2_NOMEENG
  'E'																		, ; //X2_MODO
  ''																		, ; //X2_TTS
  ''																		, ; //X2_ROTINA
  ''																		, ; //X2_PYME
...
//
  ...
  aAdd( aSX3, { ;
    { 'ZNC'																	, .F. }, ; //X3_ARQUIVO
  { '03'																	, .F. }, ; //X3_ORDEM
  { 'ZNC_ORIGEM'															, .F. }, ; //X3_CAMPO
  { 'C'																	, .F. }, ; //X3_TIPO
  { 1																		, .F. }, ; //X3_TAMANHO
  { 0																		, .F. }, ; //X3_DECIMAL
  { 'Origem RPV'															, .F. }, ; //X3_TITULO
  { 'Origem RPV'															, .F. }, ; //X3_TITSPA
  { 'Origem RPV'															, .F. }, ; //X3_TITENG
  { 'Origem RPV'															, .F. }, ; //X3_DESCRIC
  { 'Origem RPV'															, .F. }, ; //X3_DESCSPA
  { 'Origem RPV'															, .F. }, ; //X3_DESCENG
  { ''																	, .F. }, ; //X3_PICTURE
  { ''																	, .F. }, ; //X3_VALID
  { Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
    Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
  ...
  { '€'																	, .F. }, ; //X3_OBRIGAT
  { ''																	, .F. }, ; //X3_VLDUSER
  { '1=NF Entrada;2=Ped.Vendas;3=Lib.Financeira;'							, .F. }, ; //X3_CBOX
  { '1=NF Entrada;2=Ped.Vendas;3=Lib.Financeira;'							, .F. }, ; //X3_CBOXSPA
  { '1=NF Entrada;2=Ped.Vendas;3=Lib.Financeira;'							, .F. }, ; //X3_CBOXENG
  { ''																	, .F. }, ; //X3_PICTVAR
  { ''																	, .F. }, ; //X3_WHEN
  { ''																	, .F. }, ; //X3_INIBRW
  { ''																	, .F. }, ; //X3_GRPSXG
  ...
  { 'Chave 1'																, .F. }, ; //X3_TITSPA
  { 'Chave 1'																, .F. }, ; //X3_TITENG
  { 'Chave 1'																, .F. }, ; //X3_DESCRIC
  { 'Chave 1'																, .F. }, ; //X3_DESCSPA
  { 'Chave 1'																, .F. }, ; //X3_DESCENG
  { ''																	, .F. }, ; //X3_PICTURE
  { ''																	, .F. }, ; //X3_VALID
  { Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
    Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
  ...
  aAdd( aSX3, { ;
    { 'ZNC'																	, .F. }, ; //X3_ARQUIVO
  { '06'																	, .F. }, ; //X3_ORDEM
  { 'ZNC_VALOR'															, .F. }, ; //X3_CAMPO
  { 'N'																	, .F. }, ; //X3_TIPO
  { 14																	, .F. }, ; //X3_TAMANHO
  { 2																		, .F. }, ; //X3_DECIMAL
  { 'Valor Rateio'														, .F. }, ; //X3_TITULO
  { 'Valor Rateio'														, .F. }, ; //X3_TITSPA
  { 'Valor Rateio'														, .F. }, ; //X3_TITENG
  { 'Valor Rateio'														, .F. }, ; //X3_DESCRIC
  { 'Valor Rateio'														, .F. }, ; //X3_DESCSPA
  { 'Valor Rateio'														, .F. }, ; //X3_DESCENG
  ...
  aAdd( aSX3, { ;
    { 'ZNC'																	, .F. }, ; //X3_ARQUIVO
  { '07'																	, .F. }, ; //X3_ORDEM
  { 'ZNC_FLGGRV'															, .F. }, ; //X3_CAMPO
  { 'C'																	, .F. }, ; //X3_TIPO
  { 1																		, .F. }, ; //X3_TAMANHO
  { 0																		, .F. }, ; //X3_DECIMAL
  { 'Flag Gravado'														, .F. }, ; //X3_TITULO
  { 'Flag Gravado'														, .F. }, ; //X3_TITSPA
  { 'Flag Gravado'														, .F. }, ; //X3_TITENG
  { 'Flag Gravado'														, .F. }, ; //X3_DESCRIC
  { 'Flag Gravado'														, .F. }, ; //X3_DESCSPA
  { 'Flag Gravado'														, .F. }, ; //X3_DESCENG
  { '@!'																	, .F. }, ; //X3_PICTURE
  { ''																	, .F. }, ; //X3_VALID
  { Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
    Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
//
  aAdd( aSIX, { ;
    'ZNC'																	, ; //INDICE
  '1'																		, ; //ORDEM
  'ZNC_FILIAL+ZNC_ORIGEM+ZNC_CHV1+ZNC_CODRPV'								, ; //CHAVE
  'Filial+Origem RPV+Chave 1+RPV'											, ; //DESCRICAO
  'Filial+Origem RPV+Chave 1+RPV'											, ; //DESCSPA
  'Filial+Origem RPV+Chave 1+RPV'											, ; //DESCENG
  'U'																		, ; //PROPRI
  ''																		, ; //F3
  ''																		, ; //NICKNAME
  'S'																		} ) //SHOWPESQ
  ...
  aAdd( aSIX, { ;
    'ZNC'																	, ; //INDICE
  '2'																		, ; //ORDEM
  'ZNC_FILIAL+ZNC_CODRPV'													, ; //CHAVE
  'Filial+RPV'															, ; //DESCRICAO
  'Filial+RPV'															, ; //DESCSPA
  'Filial+RPV'															, ; //DESCENG
  'U'																		, ; //PROPRI
  ''																		, ; //F3
...
// Marca/Desmarca por mascara
  ...
  @ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "ZNC001" ) ) ) ;
