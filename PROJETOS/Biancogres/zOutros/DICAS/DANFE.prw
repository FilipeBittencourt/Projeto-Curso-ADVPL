...
static function CarDanfe(oSetupDanf, cNomeArq)
  ...
  Local oFont04N   		:= TFont():New("Times New Roman",,04,.T.,.T.) // 4N
  Local oFont05    		:= TFont():New("Times New Roman",,05,.T.) // 5
  Local oFont05N   		:= TFont():New("Times New Roman",,05,.T.,.T.) // 5N
  ...
  oDanfe:Say(170,405,"CNPJ/CPF",oFont06N)
  oDanfe:Say(180,405,IIf(XmlChildEx(oXml:_NFE:_INFNFE:_EMIT, "_CNPJ")<>nil,TransForm(oXml:_NFE:_INFNFE:_EMIT:_CNPJ:TEXT,"@r 99.999.999/9999-99"),TransForm(oXml:_NFE:_INFNFE:_EMIT:_CPF:TEXT,"@r 999.999.999-99")),oFont11)
  ...
  If XmlChildEx(oXml:_NFE:_INFNFE:_DEST, "_CNPJ")<>nil
    cCNPJCPF := TransForm(oXml:_NFE:_INFNFE:_DEST:_CNPJ:TEXT,"@r 99.999.999/9999-99")
    oDanfe:Say(215,283,cCNPJCPF,oFont11)
  EndIf

  If XmlChildEx(oXml:_NFE:_INFNFE:_DEST, "_CPF")<>nil
    cCNPJCPF := TransForm(oXml:_NFE:_INFNFE:_DEST:_CPF:TEXT,"@r 999.999.999-99")
    oDanfe:Say(215,283,cCNPJCPF,oFont11)
  EndIf

  //Importado ver tag
  If XmlChildEx(oXml:_NFE:_INFNFE, "_AUTXML")<>nil .AND. Empty(cCNPJCPF)
    If XmlChildEx(oXml:_NFE:_INFNFE:_AUTXML, "_CNPJ")<>nil
      oDanfe:Say(215,283,TransForm(oXml:_NFE:_INFNFE:_AUTXML:_CNPJ:TEXT,"@r 99.999.999/9999-99"),oFont11)
    EndIf
    If XmlChildEx(oXml:_NFE:_INFNFE:_AUTXML, "_CPF")<>nil
      oDanfe:Say(215,283,TransForm(oXml:_NFE:_INFNFE:_AUTXML:_CPF:TEXT,"@r 999.999.999-99"),oFont11)
    EndIf
  EndIf
  ...
  aTotais[01] := iif(XmlChildEx(oXml:_NFE:_INFNFE:_TOTAL:_ICMSTOT, "_VBC")<>nil ,ConvValDec(oXml:_NFE:_INFNFE:_TOTAL:_ICMSTOT:_VBC:TEXT),"0,00")
  aTotais[02] := iif(XmlChildEx(oXml:_NFE:_INFNFE:_TOTAL:_ICMSTOT, "_VICMS")<>nil ,ConvValDec(oXml:_NFE:_INFNFE:_TOTAL:_ICMSTOT:_VICMS:TEXT),"0,00")
  aTotais[03] := iif(XmlChildEx(oXml:_NFE:_INFNFE:_TOTAL:_ICMSTOT, "_VBCST")<>nil ,ConvValDec(oXml:_NFE:_INFNFE:_TOTAL:_ICMSTOT:_VBCST:TEXT),"0,00")
  aTotais[04] := iif(XmlChildEx(oXml:_NFE:_INFNFE:_TOTAL:_ICMSTOT, "_VST")<>nil ,ConvValDec(oXml:_NFE:_INFNFE:_TOTAL:_ICMSTOT:_VST:TEXT),"0,00")
  aTotais[05] := iif(XmlChildEx(oXml:_NFE:_INFNFE:_TOTAL:_ICMSTOT, "_VPROD")<>nil ,ConvValDec(oXml:_NFE:_INFNFE:_TOTAL:_ICMSTOT:_VPROD:TEXT),"0,00")
  aTotais[06] := iif(XmlChildEx(oXml:_NFE:_INFNFE:_TOTAL:_ICMSTOT, "_VFRETE")<>nil ,ConvValDec(oXml:_NFE:_INFNFE:_TOTAL:_ICMSTOT:_VFRETE:TEXT),"0,00")
  aTotais[07] := iif(XmlChildEx(oXml:_NFE:_INFNFE:_TOTAL:_ICMSTOT, "_VSEG")<>nil ,ConvValDec(oXml:_NFE:_INFNFE:_TOTAL:_ICMSTOT:_VSEG:TEXT),"0,00")
  aTotais[08] := iif(XmlChildEx(oXml:_NFE:_INFNFE:_TOTAL:_ICMSTOT, "_VDESC")<>nil ,ConvValDec(oXml:_NFE:_INFNFE:_TOTAL:_ICMSTOT:_VDESC:TEXT),"0,00")
  aTotais[09] := iif(XmlChildEx(oXml:_NFE:_INFNFE:_TOTAL:_ICMSTOT, "_VOUTRO")<>nil ,ConvValDec(oXml:_NFE:_INFNFE:_TOTAL:_ICMSTOT:_VOUTRO:TEXT),"0,00")
  aTotais[10] := iif(XmlChildEx(oXml:_NFE:_INFNFE:_TOTAL:_ICMSTOT, "_VIPI")<>nil ,ConvValDec(oXml:_NFE:_INFNFE:_TOTAL:_ICMSTOT:_VIPI:TEXT),"0,00")
  aTotais[11] := iif(XmlChildEx(oXml:_NFE:_INFNFE:_TOTAL:_ICMSTOT, "_VNF")<>nil ,ConvValDec(oXml:_NFE:_INFNFE:_TOTAL:_ICMSTOT:_VNF:TEXT),"0,00")

  aTotais[12] := iif(XmlChildEx(oXml:_NFE:_INFNFE:_TOTAL:_ICMSTOT, "_VII")<>nil ,ConvValDec(oXml:_NFE:_INFNFE:_TOTAL:_ICMSTOT:_VII:TEXT),"0,00")
  aTotais[13] := iif(XmlChildEx(oXml:_NFE:_INFNFE:_TOTAL:_ICMSTOT, "_VICMSUFREMET")<>nil ,ConvValDec(oXml:_NFE:_INFNFE:_TOTAL:_ICMSTOT:_VICMSUFREMET:TEXT),"0,00")
  aTotais[14] := iif(XmlChildEx(oXml:_NFE:_INFNFE:_TOTAL:_ICMSTOT, "_VFCP")<>nil ,ConvValDec(oXml:_NFE:_INFNFE:_TOTAL:_ICMSTOT:_VFCP:TEXT),"0,00")
  aTotais[15] := iif(XmlChildEx(oXml:_NFE:_INFNFE:_TOTAL:_ICMSTOT, "_VPIS")<>nil ,ConvValDec(oXml:_NFE:_INFNFE:_TOTAL:_ICMSTOT:_VPIS:TEXT),"0,00")
  aTotais[16] := iif(XmlChildEx(oXml:_NFE:_INFNFE:_TOTAL:_ICMSTOT, "_VICMSUFDEST")<>nil ,ConvValDec(oXml:_NFE:_INFNFE:_TOTAL:_ICMSTOT:_VICMSUFDEST:TEXT),"0,00")
  aTotais[17] := iif(XmlChildEx(oXml:_NFE:_INFNFE:_TOTAL:_ICMSTOT, "_VTOTTRIB")<>nil ,ConvValDec(oXml:_NFE:_INFNFE:_TOTAL:_ICMSTOT:_VTOTTRIB:TEXT),"0,00")
  aTotais[18] := iif(XmlChildEx(oXml:_NFE:_INFNFE:_TOTAL:_ICMSTOT, "_VCOFINS")<>nil ,ConvValDec(oXml:_NFE:_INFNFE:_TOTAL:_ICMSTOT:_VCOFINS:TEXT),"0,00")



  oDanfe:Say(305,002,"CALCULO DO IMPOSTO",oFont06N)
  oDanfe:Box(307,065,330,000)
  oDanfe:Say(313,001,"B. Calc. ICMS",oFont06N)
  oDanfe:SayAlign(317, 005,aTotais[01],oFont08,70,21,,2,2)

  oDanfe:Box(307,130,330,065)
  oDanfe:Say(313,066,"Vlr. do ICMS",oFont06N)
  oDanfe:SayAlign(317,070,aTotais[02],oFont08,70,21,,2,2)

  oDanfe:Box(307,195,330,130)
  oDanfe:Say(313,131,"B. Calc. ICMS SUBST.",oFont06N) //+72
  oDanfe:SayAlign(317,135,aTotais[03],oFont08,70,21,,2,2) //+70


  oDanfe:Box(307,260,330,195)
  oDanfe:Say(313,196,"Vlr. do ICMS SUBST.",oFont06N)
  oDanfe:SayAlign(317,200,aTotais[04],oFont08,70,21,,2,2)


  oDanfe:Box(307,325,330,260)
  oDanfe:Say(313,261,"Vlr. IMP. Importação",oFont06N)
  oDanfe:SayAlign(317,265,aTotais[12],oFont08,70,21,,2,2)


  oDanfe:Box(307,390,330,325)
  oDanfe:Say(313,326,"Vlr. ICMS UF Remet.",oFont06N)
  oDanfe:SayAlign(317,330,aTotais[13],oFont08,70,21,,2,2)


  oDanfe:Box(307,455,330,390)
  oDanfe:Say(313,391,"Vlr. do FCP",oFont06N)
  oDanfe:SayAlign(317,395,aTotais[14],oFont08,70,21,,2,2)

  oDanfe:Box(307,520,330,455)
  oDanfe:Say(313,456,"Vlr. do PIS",oFont06N)
  oDanfe:SayAlign(317,460,aTotais[15],oFont08,70,21,,2,2)

  oDanfe:Box(307,603,330,520)
  oDanfe:Say(313,521,"Vlr. Total dos PRODUTOS",oFont06N)
  oDanfe:SayAlign(317,525,aTotais[05],oFont08,70,21,,2,2)

  //SEGUNDA LINHA DOS IMPOSTOS



  oDanfe:Box(330,065,353,000)
  oDanfe:Say(336,001,"Vlr. Frete",oFont06N)
  oDanfe:SayAlign(340,005,aTotais[06],oFont08,70,21,,2,2)

  oDanfe:Box(330,130,353,065)
  oDanfe:Say(336,066,"Vlr. do Seguro",oFont06N)
  oDanfe:SayAlign(340,070,aTotais[07],oFont08,70,21,,2,2)

  oDanfe:Box(330,195,353,130)
  oDanfe:Say(336,131,"Desconto",oFont06N)
  oDanfe:SayAlign(340,135,aTotais[08],oFont08,70,21,,2,2)

  oDanfe:Box(330,260,353,195)
  oDanfe:Say(336,196,"Outras Despesas",oFont06N)
  oDanfe:SayAlign(340,200,aTotais[09],oFont08,70,21,,2,2)

  oDanfe:Box(330,325,353,260)
  oDanfe:Say(336,261,"Vlr. do IPI",oFont06N)
  oDanfe:SayAlign(340,265,aTotais[10],oFont08,70,21,,2,2)

  oDanfe:Box(330,390,353,325)
  oDanfe:Say(336,326,"Vlr. ICMS UF DEST.",oFont06N)
  oDanfe:SayAlign(340,330,aTotais[16],oFont08,70,21,,2,2)

  oDanfe:Box(330,455,353,390)
  oDanfe:Say(336,391,"Vlr. Total TRIB.",oFont06N)
  oDanfe:SayAlign(340,395,aTotais[17],oFont08,70,21,,2,2)

  oDanfe:Box(330,520,353,455)
  oDanfe:Say(336,456,"Vlr. da COFINS",oFont06N)
  oDanfe:SayAlign(340,460,aTotais[18],oFont08,70,21,,2,2)


  oDanfe:Box(330,603,353,520)
  oDanfe:Say(336,521,"Vlr. Total da NOTA",oFont06N)
  oDanfe:SayAlign(340,525,aTotais[11],oFont08,70,21,,2,2)
  ...
  if XmlChildEx(oXml:_NFE:_INFNFE, "_INFADIC")<>NIL
    ...
    if XmlChildEx(oXml:_NFE:_INFNFE:_INFADIC, "_OBSCONT")<>NIL

      if ValType(oXml:_NFE:_INFNFE:_INFADIC:_OBSCONT) == "O"

        cinfcomp += " "+oXml:_NFE:_INFNFE:_INFADIC:_OBSCONT:_XCAMPO:TEXT+":"+oXml:_NFE:_INFNFE:_INFADIC:_OBSCONT:_XTEXTO:TEXT + " "

      elseIf ValType(oXml:_NFE:_INFNFE:_INFADIC:_OBSCONT) == "A"

        for cont := 1 to len(oXml:_NFE:_INFNFE:_INFADIC:_OBSCONT)

          cinfcomp += " "+oXml:_NFE:_INFNFE:_INFADIC:_OBSCONT[cont]:_XCAMPO:TEXT+":"+oXml:_NFE:_INFNFE:_INFADIC:_OBSCONT[cont]:_XTEXTO:TEXT + " "
  ...
  if XmlChildEx(oXml:_NFE:_INFNFE:_IDE, "_NFREF")<>NIL
    for cont := 1 to len(oXml:_NFE:_INFNFE:_IDE:_NFREF)
      cAuxInfo := " - "
      cAuxInfo += "  NFe Ref.: Doc/Serie:"+substr(oXml:_NFE:_INFNFE:_IDE:_NFREF[cont]:_REFNFE:TEXT,26,9)+'/'+substr(oXml:_NFE:_INFNFE:_IDE:_NFREF[cont]:_REFNFE:TEXT,23,3)
      cAuxInfo += "  Emit.:"+substr(oXml:_NFE:_INFNFE:_IDE:_NFREF[cont]:_REFNFE:TEXT,7,14)
      cAuxInfo += "  em.:"+substr(oXml:_NFE:_INFNFE:_IDE:_NFREF[cont]:_REFNFE:TEXT,5,2)+'/'+substr(oXml:_NFE:_INFNFE:_IDE:_NFREF[cont]:_REFNFE:TEXT,3,2)
      cAuxInfo += "  ["+oXml:_NFE:_INFNFE:_IDE:_NFREF[cont]:_REFNFE:TEXT+"] "
      cinfcomp += cAuxInfo
    Next cont
  endif

  if XmlChildEx(oXml:_NFE:_INFNFE:_DEST, "_EMAIL")<>NIL
    cinfcomp += " - Email do Destinatário: "+oXml:_NFE:_INFNFE:_DEST:_EMAIL:TEXT
  endif

  ncontrol := 0
  nlincont := 730
  while ncontrol <= Len(cinfcomp)

    If !Empty(substr(cinfcomp,ncontrol,96))
      oDanfe:SayAlign(nlincont, 006,AllTRim(substr(UPPER(cinfcomp),ncontrol,96)),oFont06,340,500,,0,0)
      ncontrol += 96
      nlincont += 9
    else
      ncontrol := Len(cinfcomp) +1
    EndIf
        ...
        if CstCsons == "CST"
          For nY := 1 To Len(aSitTrib)
            If XmlChildEx(oXml:_NFE:_INFNFE:_DET[cont]:_IMPOSTO:_ICMS, "_ICMS"+aSitTrib[nY]) <> NIL
              ...
              If XmlChildEx(oXml:_NFE:_INFNFE:_DET[cont], "_INFADPROD") <> NIL
                citens[2] := citens[2] +' '+AllTrim(oXml:_NFE:_INFNFE:_DET[cont]:_INFADPROD:TEXT)
              EndIf

              If XmlChildEx(oimposto, "_PREDBC") <> NIL
                citens[2] := citens[2] +' pRedBC='+cValtoChar(oimposto:_PREDBC:TEXT)+'% '
              EndIf

              If XmlChildEx(oimposto, "_PMVAST") <> NIL
                citens[2] := citens[2] +' IVA='+cValtoChar(oimposto:_PMVAST:TEXT)+'% '
              EndIf

              If XmlChildEx(oimposto, "_PICMSST") <> NIL
                citens[2] := citens[2] +' pIcmsSt='+cValtoChar(oimposto:_PICMSST:TEXT)+'% '
              EndIf

              If XmlChildEx(oimposto, "_VBCST") <> NIL
                citens[2] := citens[2] +' bcIcmsSt='+cValtoChar(oimposto:_VBCST:TEXT)
              EndIf

              If XmlChildEx(oimposto, "_VICMSST") <> NIL
                citens[2] := citens[2] +' vIcmsSt='+cValtoChar(oimposto:_VICMSST:TEXT)
              EndIf

              If XmlChildEx(oXml:_NFE:_INFNFE:_DET[cont]:_PROD, "_CEAN") <> NIL
                citens[2] := citens[2] +' cEAN='+cValtoChar(oXml:_NFE:_INFNFE:_DET[cont]:_PROD:_CEAN:TEXT)
              EndIf

              If XmlChildEx(oXml:_NFE:_INFNFE:_DET[cont]:_PROD, "_CEANTRIB") <> NIL
                citens[2] := citens[2] +' cEANTrib='+cValtoChar(oXml:_NFE:_INFNFE:_DET[cont]:_PROD:_CEANTRIB:TEXT)
              EndIf
  ...
  while nLinha <= nlimite .AND. nitensini <= nitens
    ...
    if len(aAux[nitensini,2]) > 35
      ...
      for cont:=1 to cdescpro
        oDanfe:SayAlign(nLinha+nlincont, nAuxH + 2,AllTRim(substr(aAux[nitensini,2],ncontrol,35)),oFont06,aTamCol[2],8,,0,1)
        ncontrol += 35
        nlincont += 6
      next cont
    else
    ...
    while nitensini <= nitens
      ...
      while nLinha <= nlimite .AND. nitensini <= nitens
        ...
        if len(aAux[nitensini,2]) > 35
          ...
          oDanfe:SayAlign(nLinha, nAuxH + 2,aAux[nitensini,2],oFont06,aTamCol[2],8,,0,1) // DESCRICAO DO PRODUTO 2
        endif
        /*if len(aAux[nitensini,2]) > 35
          cdescpro:= INT(len(aAux[nitensini,2])/35)
        if MOD(len(aAux[nitensini,2]),35) > 0
          ...
          oDanfe:SayAlign(nLinha, nAuxH + 2,aAux[nitensini,2],oFont05,aTamCol[2] ,(cdescpro*8),,0,1) // DESCRICAO DO PRODUTO 2
      else
          oDanfe:SayAlign(nLinha, nAuxH + 2,aAux[nitensini,2],oFont05,aTamCol[2] ,8,,0,1) // DESCRICAO DO PRODUTO 2
      endif*/
        ...
        //oDanfe:SayAlign(          nLinha, 000,     " - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - " ,oFont05,     600         ,8   ,            ,       0           ,1)
