...
aAdd( aSX2, { ;
	'UD4'																	, ; //X2_CHAVE
	cPath																	, ; //X2_PATH
	'UD4'+cEmpr																, ; //X2_ARQUIVO
	'LISTA DE DEMANDAS'														, ; //X2_NOME
	'LISTA DE DEMANDAS'														, ; //X2_NOMESPA
	'LISTA DE DEMANDAS'														, ; //X2_NOMEENG
	'E'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSIX, { ;
	'UD4'																	, ; //INDICE
	'1'																		, ; //ORDEM
	'UD4_FILIAL+UD4_DOC+UD4_IDPLAN+UD4_BITOLA+UD4_STATUS'					, ; //CHAVE
	'Documento+Plano Corte+Bitola+Status'									, ; //DESCRICAO
	'Documento+Plano Corte+Bitola+Status'									, ; //DESCSPA
	'Documento+Plano Corte+Bitola+Status'									, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	'UD4'																	, ; //INDICE
	'2'																		, ; //ORDEM
	'UD4_FILIAL+UD4_DOC+UD4_BITOLA'											, ; //CHAVE
	'Documento+Bitola'														, ; //DESCRICAO
	'Documento+Bitola'														, ; //DESCSPA
	'Documento+Bitola'														, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	'UD4'																	, ; //INDICE
	'3'																		, ; //ORDEM
	'UD4_FILIAL+UD4_DOC+UD4_TAMBAR'											, ; //CHAVE
	'Documento+Compr. Barra'												, ; //DESCRICAO
	'Documento+Compr. Barra'												, ; //DESCSPA
	'Documento+Compr. Barra'												, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'N'																		} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	'UD4'																	, ; //INDICE
	'4'																		, ; //ORDEM
	'UD4_FILIAL+UD4_DOC+UD4_LENGTH+UD4_WIDTH'								, ; //CHAVE
	'Documento+Comprimento+Largura'											, ; //DESCRICAO
	'Documento+Comprimento+Largura'											, ; //DESCSPA
	'Documento+Comprimento+Largura'											, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'N'																		} ) //SHOWPESQ
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'DB'																	, ; //XB_COLUNA
	'Lista Separacao'														, ; //XB_DESCRI
	'Lista Separacao'														, ; //XB_DESCSPA
	'Lista Separacao'														, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'UD4'																	} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'01'																	, ; //XB_COLUNA
	'Documento+plano Cort'													, ; //XB_DESCRI
	'Documento+plano Cort'													, ; //XB_DESCSPA
	'Documento+plano Cort'													, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	''																		} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_COLUNA
	'Documento'																, ; //XB_DESCRI
	'Documento'																, ; //XB_DESCSPA
	'Documento'																, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'UD4_DOC'																} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'02'																	, ; //XB_COLUNA
	'Plano Corte'															, ; //XB_DESCRI
	'Plano Corte'															, ; //XB_DESCSPA
	'Plano Corte'															, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'UD4_IDPLAN'															} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	''																		, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'U_FILTROUD4(UD4->UD4_DOC,UD4->UD4_IDPLAN)'								} ) //XB_CONTEM
