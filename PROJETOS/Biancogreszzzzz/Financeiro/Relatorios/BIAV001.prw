...
Programação idêntica ao FINR130 para preenchimento do Liquidez utilizado no PowerBI 
*/

USER Function BIAV001(lAuto)
Local oReport
...
U_wfSend01() // Thiago Haagensen - Ticket 26109 - Notificação por e-mail
...
While lContinua
	...
	*/
	...
	If lSchedule
		...
		cFltUsrSA1 := " A1_YSITGRP = '1' OR A1_YSITGRP = '5' "
	...
	While !Eof() .And. SE1->E1_FILIAL == cFilSE1 .And. &cCond1
		...
		While !Eof() .And. SE1->E1_FILIAL == cFilSE1 .And. &cCond2 == cCarAnt
			...
			//Ticket 18911
			If (SE1->E1_CLIENTE == "007871" .or. SE1->E1_CLIENTE == "026423")
				SE1->(dbSkip())
				Loop
			Endif
...
//Executa Job para integração com tabelas do DW
//U_EXEJBSQL("HERMES", "DW->Financeiro Liquidez", "Sincronizando Dados com BI")
Return
...
Static Function insertDados(aDados, dDataBase)
	...
	If !Empty(aDados[CLIENT]) 
		If cCodEmp == "01" .Or. cCodEmp == "05"
	        cSql := "INSERT INTO __BI_PB_CRE  (BK_EMPRESA, BK_FILIAL, BK_CLIENTE, NUM_TIT, NATUREZA, VENCTO, DTBAIXA, SALDO, TOTAL_BAIXADO, VALOR_TOTAL, CATEGORIA, SEGMENTO, RISCO, DATA_BASE, TIPO, EMPORIGEM, EMPRESA, FILIAL, CLIENTE, MARCA) VALUES"
