...
/*/
//--------------------------------------------------------------------
User Function UPDZJ001( cEmpAmb, cFilAmb ) 

Local   aSay      := {}
Local   aButton   := {}
Local   aMarcadas := {}
Local   cTitulo   := "ATUALIZAÇÃO DE DICIONÁRIOS E TABELAS DO SISTEMA (SIX/SX2/SX3)"
Local   cDesc1    := "Projeto: Automacao Fianceira - Classe de Valor" 
Local   cDesc2    := "Autor: Facile - Data: 16/10/2018" 
Local   cDesc3    := ""
Local   cDesc4    := "Descrição: Criacao de tabela para substituicao dos campos "
Local   cDesc5    := "utilizados para classe gatilho de classe de valor no "
Local   cDesc6    := "movimento bancario."
Local   cDesc7    := ""
Local   cMsg      := ""
Local   lOk       := .F.
...
*/
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDZJ001" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDZJ001" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX2, { ;
	...
	cPath																	, ; //X2_PATH
	'ZJ0010'																, ; //X2_ARQUIVO
	'NATUREZA X CLASSES DE VALOR'											, ; //X2_NOME
	'NATUREZA X CLASSES DE VALOR'											, ; //X2_NOMESPA
	'NATUREZA X CLASSES DE VALOR'											, ; //X2_NOMEENG
	'C'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX3, { ;
	{ 'ZJ0'																	, .T. }, ; //X3_ARQUIVO
	{ '02'																	, .T. }, ; //X3_ORDEM
	{ 'ZJ0_NATURE'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 10																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Natureza'															, .T. }, ; //X3_TITULO
	{ 'Natureza'															, .T. }, ; //X3_TITSPA
	{ 'Natureza'															, .T. }, ; //X3_TITENG
	{ 'Natureza'															, .T. }, ; //X3_DESCRIC
	{ 'Natureza'															, .T. }, ; //X3_DESCSPA
	{ 'Natureza'															, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	{ 'R'																	, .T. }, ; //X3_CONTEXT
	{ 'Á'																	, .T. }, ; //X3_OBRIGAT
	{ 'ExistCpo("SED", FwFldGet("ZJ0_NATURE"), 1)'							, .T. }, ; //X3_VLDUSER
	{ ''																	, .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	...
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ ''																	, .T. }, ; //X3_WHEN
	{ 'Posicione("SED", 1, xFilial("SED") + ZJ0->ZJ0_NATURE, "ED_DESCRIC")'	, .T. }, ; //X3_INIBRW
	{ ''																	, .T. }, ; //X3_GRPSXG
	{ ''																	, .T. }, ; //X3_FOLDER
	{ ''																	, .T. }, ; //X3_CONDSQL
	{ ''																	, .T. }, ; //X3_CHKSQL
...
aAdd( aSX3, { ;
	...
	{ 'Rec/Pag'															, .T. }, ; //X3_TITSPA
	{ 'Rec/Pag'															, .T. }, ; //X3_TITENG
	{ 'Rec/Pag'															, .T. }, ; //X3_DESCRIC
	{ 'Rec/Pag'															, .T. }, ; //X3_DESCSPA
	{ 'Rec/Pag'															, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'ZJ0'																	, .T. }, ; //X3_ARQUIVO
	{ '05'																	, .T. }, ; //X3_ORDEM
	{ 'ZJ0_CLVLCR'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 9																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Cl Valor Crd'														, .T. }, ; //X3_TITULO
	{ 'Cl Valor Crd'														, .T. }, ; //X3_TITSPA
	{ 'Cl Valor Crd'														, .T. }, ; //X3_TITENG
	{ 'Cl Valor Crd'														, .T. }, ; //X3_DESCRIC
	{ 'Cl Valor Crd'														, .T. }, ; //X3_DESCSPA
	{ 'Cl Valor Crd'														, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	{ 'R'																	, .T. }, ; //X3_CONTEXT
	{ ''																	, .T. }, ; //X3_OBRIGAT
	{ 'ExistCpo("CTH", FwFldGet("ZJ0_CLVLCR"), 1)'							, .T. }, ; //X3_VLDUSER
	{ ''																	, .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	{ 'ZJ0'																	, .T. }, ; //X3_ARQUIVO
	{ '06'																	, .T. }, ; //X3_ORDEM
	{ 'ZJ0_CLVLDB'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 9																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Cl Valor Deb'														, .T. }, ; //X3_TITULO
	{ 'Cl Valor Deb'														, .T. }, ; //X3_TITSPA
	{ 'Cl Valor Deb'														, .T. }, ; //X3_TITENG
	{ 'Cl Valor Deb'														, .T. }, ; //X3_DESCRIC
	{ 'Cl Valor Deb'														, .T. }, ; //X3_DESCSPA
	{ 'Cl Valor Deb'														, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	{ 'R'																	, .T. }, ; //X3_CONTEXT
	{ ''																	, .T. }, ; //X3_OBRIGAT
	{ 'ExistCpo("CTH", FwFldGet("ZJ0_CLVLDB"), 1)'							, .T. }, ; //X3_VLDUSER
	{ ''																	, .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	...
	{ 'Emp/Filial'															, .T. }, ; //X3_DESCRIC
	{ 'Emp/Filial'															, .T. }, ; //X3_DESCSPA
	{ 'Emp/Filial'															, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SED'																	, .T. }, ; //X3_ARQUIVO
	{ '58'																	, .T. }, ; //X3_ORDEM
	{ 'ED_YCLVLI'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 9																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'CLVL Incesa'															, .T. }, ; //X3_TITULO
	{ 'CLVL Incesa'															, .T. }, ; //X3_TITSPA
	{ 'CLVL Incesa'															, .T. }, ; //X3_TITENG
	{ 'CLVL Incesa'															, .T. }, ; //X3_DESCRIC
	{ 'CLVL Incesa'															, .T. }, ; //X3_DESCSPA
	{ 'CLVL Incesa'															, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSIX, { ;
	'ZJ0'																	, ; //INDICE
	'1'																		, ; //ORDEM
	'ZJ0_FILIAL+ZJ0_NATURE+ZJ0_EMPFIL+ZJ0_RECPAG'						, ; //CHAVE
	'Natureza'																, ; //DESCRICAO
	'Natureza'																, ; //DESCSPA
	'Natureza'																, ; //DESCENG
	'U'																		, ; //PROPRI
...
aAdd( aSX7, { ;
	'E5_NATUREZ'								, ; //X7_CAMPO
	'004'										, ; //X7_SEQUENC
	'U_BIA478G("ZJ0_CLVLDB", M->E5_NATUREZ, cRecPag)', ; //X7_REGRA
	'E5_CLVLDB'			     					, ; //X7_CDOMIN
	'P'							              	, ; //X7_TIPO
	'N'							               , ; //X7_SEEK
	''							       			, ; //X7_ALIAS
...
aAdd( aSX7, { ;
	'E5_NATUREZ'								, ; //X7_CAMPO
	'005'										, ; //X7_SEQUENC
	'U_BIA478G("ZJ0_CLVLCR", M->E5_NATUREZ, cRecPag)', ; //X7_REGRA
	'E5_CLVLCR'			     					, ; //X7_CDOMIN
	'P'							              	, ; //X7_TIPO
	'N'							               , ; //X7_SEEK
	''							       			, ; //X7_ALIAS
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'DB'																	, ; //XB_COLUNA
	'Empresa/Filial'														, ; //XB_DESCRI
	'Empresa/Filial'														, ; //XB_DESCSPA
	'Empresa/Filial'														, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'SM0'																	} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'02'																	, ; //XB_COLUNA
	'Cod.Filial'															, ; //XB_DESCRI
	'Cod.Filial'															, ; //XB_DESCSPA
	'Cod.Filial'															, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'M0_CODFIL'																} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	''																		, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'SM0->M0_CODIGO + SM0->M0_CODFIL'										} ) //XB_CONTEM
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPDZJ001" ) ) ) ;
