...
ฒฑฑบPrograma  ณ FOR_SPEEDบAutor  ณ MADALENO           บ Data ณ  14/05/09   บฑฑฒ
ฒฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑฒ
ฒฑฑบDesc.     ณ ROTINA PARA ENVIAR ENVIAR DADOS DO FORNEC. QUE NAO FORAM   บฑฑฒ
...
IF ! FOR_PEED->(EOF())
	...
	C_HTML += '  <tr> '
	C_HTML += '    <th width="568" rowspan="3" scope="col"> RELA&Ccedil;&Atilde;O FORNECEDORES QUE N&Atilde;O FORAM ATUALIZADOS PARA SPED COM PEDIDOS NรO ATENDIDOS </th> '
...
cRecebeCC	:= "" 	
cRecebeCO	:= ""	
cAssunto	:= "FORNECEDORES NรO ATUALIZADOS"							// Assunto do Email
