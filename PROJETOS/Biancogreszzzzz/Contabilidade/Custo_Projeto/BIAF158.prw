...
User Function BIAF158(cEmpAmb, cFilAmb)
Local   aSay      := {}
Local   aButton   := {}
Local   aMarcadas := {}
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDTAF07" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDTAF07" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX2, { ;
	...
	cPath																	, ; //X2_PATH
	'ZMA010'																, ; //X2_ARQUIVO
	'Cadastro de Subitem'													, ; //X2_NOME
	'Cadastro de Subitem'													, ; //X2_NOMESPA
	'Cadastro de Subitem'													, ; //X2_NOMEENG
	'C'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX3, { ;
	...
	{ 'Contrato'															, .T. }, ; //X3_DESCRIC
	{ 'Contrato'															, .T. }, ; //X3_DESCSPA
	{ 'Contrato'															, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
...
aAdd( aSX3, { ;
	...
	{ 'R'																	, .T. }, ; //X3_CONTEXT
	{ ''																	, .T. }, ; //X3_OBRIGAT
	{ 'ExecBlock("BIA555", .F., .F.)'										, .T. }, ; //X3_VLDUSER
	{ ''																	, .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	...
	{ 'Item Contab.'														, .T. }, ; //X3_DESCRIC
	{ 'Item Contab.'														, .T. }, ; //X3_DESCSPA
	{ 'Item Contab.'														, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SWD'																	, .T. }, ; //X3_ARQUIVO
	{ '61'																	, .T. }, ; //X3_ORDEM
	{ 'WD_YSUBITE'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 2																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Subitem Proj'														, .T. }, ; //X3_TITULO
	{ 'Subitem Proj'														, .T. }, ; //X3_TITSPA
	{ 'Subitem Proj'														, .T. }, ; //X3_TITENG
	{ 'Subitem Projeto'														, .T. }, ; //X3_DESCRIC
	{ 'Subitem Projeto'														, .T. }, ; //X3_DESCSPA
	{ 'Subitem Projeto'														, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 'Classe Valor'														, .T. }, ; //X3_TITSPA
	{ 'Classe Valor'														, .T. }, ; //X3_TITENG
	{ 'Classe Valor Contabil'												, .T. }, ; //X3_DESCRIC
	{ 'Classe Valor Contabil'												, .T. }, ; //X3_DESCSPA
	{ 'Classe Valor Contabil'												, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	{ 'R'																	, .T. }, ; //X3_CONTEXT
	{ '€'																	, .T. }, ; //X3_OBRIGAT
	{ 'ExistCpo("CTH", M->ZMA_CLVL)'										, .T. }, ; //X3_VLDUSER
	{ ''																	, .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	{ 'ZMA'																	, .T. }, ; //X3_ARQUIVO
	{ '04'																	, .T. }, ; //X3_ORDEM
	{ 'ZMA_ITEMCT'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 9																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Item Conta'															, .T. }, ; //X3_TITULO
	{ 'Item Conta'															, .T. }, ; //X3_TITSPA
	{ 'Item Conta'															, .T. }, ; //X3_TITENG
	{ 'Item da Conta Contabil'												, .T. }, ; //X3_DESCRIC
	{ 'Item da Conta Contabil'												, .T. }, ; //X3_DESCSPA
	{ 'Item da Conta Contabil'												, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	{ 'R'																	, .T. }, ; //X3_CONTEXT
	{ '€'																	, .T. }, ; //X3_OBRIGAT
	{ 'ExistCpo("CTD", M->ZMA_ITEMCT)'										, .T. }, ; //X3_VLDUSER
	{ ''																	, .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	{ 'ZMB'																	, .T. }, ; //X3_ARQUIVO
	{ '02'																	, .T. }, ; //X3_ORDEM
	{ 'ZMB_CODREF'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 6																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Cod Referenc'														, .T. }, ; //X3_TITULO
	{ 'Cod Referenc'														, .T. }, ; //X3_TITSPA
	{ 'Cod Referenc'														, .T. }, ; //X3_TITENG
	{ 'Codigo de Referencia'												, .T. }, ; //X3_DESCRIC
	{ 'Codigo de Referencia'												, .T. }, ; //X3_DESCSPA
	{ 'Codigo de Referencia'												, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 'Subitem'																, .T. }, ; //X3_TITSPA
	{ 'Subitem'																, .T. }, ; //X3_TITENG
	{ 'Subitem'																, .T. }, ; //X3_DESCRIC
	{ 'Subitem'																, .T. }, ; //X3_DESCSPA
	{ 'Subitem'																, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Classe Valor'														, .T. }, ; //X3_TITULO
	{ 'Clase valor'															, .T. }, ; //X3_TITSPA
	{ 'Value Class'															, .T. }, ; //X3_TITENG
	{ 'Classe de Valor'														, .T. }, ; //X3_DESCRIC
	{ 'Clase de valor'														, .T. }, ; //X3_DESCSPA
	{ 'Value Class'															, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
...
aAdd( aSX3, { ;
	{ 'SE2'																	, .T. }, ; //X3_ARQUIVO
	{ 'R0'																	, .T. }, ; //X3_ORDEM
	{ 'E2_ITEMCTA'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 9																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Item Contab.'														, .T. }, ; //X3_TITULO
	{ 'Ítem Contab.'														, .T. }, ; //X3_TITSPA
	{ 'Acc Item'															, .T. }, ; //X3_TITENG
	{ 'Item Contabil'														, .T. }, ; //X3_DESCRIC
	{ 'Ítem contable'														, .T. }, ; //X3_DESCSPA
	{ 'Accounting Item'														, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
...
aAdd( aSX3, { ;
	...
	{ 'Numero do Contrato'													, .T. }, ; //X3_DESCSPA
	{ 'Numero do Contrato'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SE2'																	, .T. }, ; //X3_ARQUIVO
	{ 'K8'																	, .T. }, ; //X3_ORDEM
	{ 'E2_YSOLPA'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 25																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Solic. do PA'														, .T. }, ; //X3_TITULO
	{ 'Solic. do PA'														, .T. }, ; //X3_TITSPA
	{ 'Solic. do PA'														, .T. }, ; //X3_TITENG
	{ 'Solicitante do PA'													, .T. }, ; //X3_DESCRIC
	{ 'Solicitante do PA'													, .T. }, ; //X3_DESCSPA
	{ 'Solicitante do PA'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 100																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Histórico 2'															, .T. }, ; //X3_TITULO
	{ 'Histórico 2'															, .T. }, ; //X3_TITSPA
	{ 'Histórico 2'															, .T. }, ; //X3_TITENG
	{ 'Histórico 2'															, .T. }, ; //X3_DESCRIC
	{ 'Histórico 2'															, .T. }, ; //X3_DESCSPA
	{ 'Histórico 2'															, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	{ 'R'																	, .T. }, ; //X3_CONTEXT
	{ ''																	, .T. }, ; //X3_OBRIGAT
	{ 'u_BIA585(M->E2_YHIST,"FIN_HIST")'									, .T. }, ; //X3_VLDUSER
	{ ''																	, .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	{ 'CT2'																	, .T. }, ; //X3_ARQUIVO
	{ 'A6'																	, .T. }, ; //X3_ORDEM
	{ 'CT2_YSUBCR'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 2																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Subitem Cred'														, .T. }, ; //X3_TITULO
	{ 'Subitem Proj'														, .T. }, ; //X3_TITSPA
	{ 'Subitem Proj'														, .T. }, ; //X3_TITENG
	{ 'Subitem Projeto'														, .T. }, ; //X3_DESCRIC
	{ 'Subitem Projeto'														, .T. }, ; //X3_DESCSPA
...
aAdd( aSX3, { ;
	{ 'CT2'																	, .T. }, ; //X3_ARQUIVO
	{ 'A7'																	, .T. }, ; //X3_ORDEM
	{ 'CT2_YSUBDB'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 2																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Subitem Deb'														, .T. }, ; //X3_TITULO
	{ 'Subitem Proj'														, .T. }, ; //X3_TITSPA
	{ 'Subitem Proj'														, .T. }, ; //X3_TITENG
	{ 'Subitem Projeto'														, .T. }, ; //X3_DESCRIC
	{ 'Subitem Projeto'														, .T. }, ; //X3_DESCSPA
...
aAdd( aSIX, { ;
	'ZMA'																	, ; //INDICE
	'2'																		, ; //ORDEM
	'ZMA_FILIAL+ZMA_CLVL'													, ; //CHAVE
	'Classe Valor'															, ; //DESCRICAO
	'Classe Valor'															, ; //DESCSPA
	'Classe Valor'															, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	'ZMB'																	, ; //INDICE
	'1'																		, ; //ORDEM
	'ZMB_FILIAL+ZMB_CODREF'													, ; //CHAVE
	'Cod Referenc'															, ; //DESCRICAO
	'Cod Referenc'															, ; //DESCSPA
	'Cod Referenc'															, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'DB'																	, ; //XB_COLUNA
	'Subitem Projeto'														, ; //XB_DESCRI
	'Subitem Projeto'														, ; //XB_DESCSPA
	'Subitem Projeto'														, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'ZMB'																	} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'01'																	, ; //XB_COLUNA
	'Cod Referenc'															, ; //XB_DESCRI
	'Cod Referenc'															, ; //XB_DESCSPA
	'Cod Referenc'															, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	''																		} ) //XB_CONTEM
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPDTAF07" ) ) ) ;
