...
Static Function MenuDef()
   ...
   // 1 opção
	...
	Local aRot := {}	
	//Adicionando opções
	ADD OPTION aRot Title 'Visualizar' Action 'VIEWDEF.ZZBMVC01' OPERATION 2 ACCESS 0 //OPERATION 2 - MODEL_OPERATION_VIEW	
	ADD OPTION aRot Title 'Incluir'    Action 'VIEWDEF.ZZBMVC01' OPERATION 3 ACCESS 0 //OPERATION 3 - MODEL_OPERATION_INSERT 
	ADD OPTION aRot Title 'Alterar'    Action 'VIEWDEF.ZZBMVC01' OPERATION 4 ACCESS 0 //OPERATION 4 - MODEL_OPERATION_UPDATE		
	ADD OPTION aRot Title 'Excluir'    Action 'VIEWDEF.ZZBMVC01' OPERATION 5 ACCESS 0 //OPERATION 5 - MODEL_OPERATION_DELETE (OUTRAS AÇOES)
